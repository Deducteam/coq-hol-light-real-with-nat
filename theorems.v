...
Axiom thm_NOT_SUC : forall n : nat, ~ ((S n) = (0)).
Axiom thm_num_INDUCTION : forall P : nat -> Prop, ((P (0)) /\ (forall n : nat, (P n) -> P (S n))) -> forall n : nat, P n.
Axiom thm_num_Axiom : forall {A : Type'}, forall e : A, forall f : A -> nat -> A, @ex1 (nat -> A) (fun fn : nat -> A => ((fn (0)) = e) /\ (forall n : nat, (fn (S n)) = (f (fn n) n))).
Axiom thm_num_CASES : forall m : nat, (m = (0)) \/ (exists n : nat, m = (S n)).
Axiom thm_PRE : ((Nat.pred (0)) = (0)) /\ (forall n : nat, (Nat.pred (S n)) = n).
Axiom thm_ADD : (forall n : nat, (Nat.add (0) n) = n) /\ (forall m : nat, forall n : nat, (Nat.add (S m) n) = (S (Nat.add m n))).
Axiom thm_ADD_0 : forall m : nat, (Nat.add m (0)) = m.
Axiom thm_ADD_SUC : forall m : nat, forall n : nat, (Nat.add m (S n)) = (S (Nat.add m n)).
Axiom thm_ADD_CLAUSES : (forall n : nat, (Nat.add (0) n) = n) /\ ((forall m : nat, (Nat.add m (0)) = m) /\ ((forall m : nat, forall n : nat, (Nat.add (S m) n) = (S (Nat.add m n))) /\ (forall m : nat, forall n : nat, (Nat.add m (S n)) = (S (Nat.add m n))))).
...
Axiom thm_ADD_EQ_0 : forall m : nat, forall n : nat, ((Nat.add m n) = (0)) = ((m = (0)) /\ (n = (0))).
...
Axiom thm_EQ_ADD_LCANCEL_0 : forall m : nat, forall n : nat, ((Nat.add m n) = m) = (n = (0)).
Axiom thm_EQ_ADD_RCANCEL_0 : forall m : nat, forall n : nat, ((Nat.add m n) = n) = (m = (0)).
Axiom thm_BIT0 : forall n : nat, (BIT0 n) = (Nat.add n n).
Axiom thm_BIT1 : forall n : nat, (BIT1 n) = (S (Nat.add n n)).
Axiom thm_BIT0_THM : forall n : nat, ((BIT0 n)) = (Nat.add (n) (n)).
Axiom thm_BIT1_THM : forall n : nat, ((BIT1 n)) = (S (Nat.add (n) (n))).
Axiom thm_ONE : ((BIT1 0)) = (S (0)).
Axiom thm_TWO : ((BIT0 (BIT1 0))) = (S ((BIT1 0))).
Axiom thm_ADD1 : forall m : nat, (S m) = (Nat.add m ((BIT1 0))).
Axiom thm_MULT : (forall n : nat, (Nat.mul (0) n) = (0)) /\ (forall m : nat, forall n : nat, (Nat.mul (S m) n) = (Nat.add (Nat.mul m n) n)).
Axiom thm_MULT_0 : forall m : nat, (Nat.mul m (0)) = (0).
Axiom thm_MULT_SUC : forall m : nat, forall n : nat, (Nat.mul m (S n)) = (Nat.add m (Nat.mul m n)).
Axiom thm_MULT_CLAUSES : (forall n : nat, (Nat.mul (0) n) = (0)) /\ ((forall m : nat, (Nat.mul m (0)) = (0)) /\ ((forall n : nat, (Nat.mul ((BIT1 0)) n) = n) /\ ((forall m : nat, (Nat.mul m ((BIT1 0))) = m) /\ ((forall m : nat, forall n : nat, (Nat.mul (S m) n) = (Nat.add (Nat.mul m n) n)) /\ (forall m : nat, forall n : nat, (Nat.mul m (S n)) = (Nat.add m (Nat.mul m n))))))).
...
Axiom thm_MULT_EQ_0 : forall m : nat, forall n : nat, ((Nat.mul m n) = (0)) = ((m = (0)) \/ (n = (0))).
Axiom thm_EQ_MULT_LCANCEL : forall m : nat, forall n : nat, forall p : nat, ((Nat.mul m n) = (Nat.mul m p)) = ((m = (0)) \/ (n = p)).
Axiom thm_EQ_MULT_RCANCEL : forall m : nat, forall n : nat, forall p : nat, ((Nat.mul m p) = (Nat.mul n p)) = ((m = n) \/ (p = (0))).
Axiom thm_MULT_2 : forall n : nat, (Nat.mul ((BIT0 (BIT1 0))) n) = (Nat.add n n).
Axiom thm_MULT_EQ_1 : forall m : nat, forall n : nat, ((Nat.mul m n) = ((BIT1 0))) = ((m = ((BIT1 0))) /\ (n = ((BIT1 0)))).
Axiom thm_EXP : (forall m : nat, (Nat.pow m (0)) = ((BIT1 0))) /\ (forall m : nat, forall n : nat, (Nat.pow m (S n)) = (Nat.mul m (Nat.pow m n))).
Axiom thm_EXP_EQ_0 : forall m : nat, forall n : nat, ((Nat.pow m n) = (0)) = ((m = (0)) /\ (~ (n = (0)))).
Axiom thm_EXP_EQ_1 : forall x : nat, forall n : nat, ((Nat.pow x n) = ((BIT1 0))) = ((x = ((BIT1 0))) \/ (n = (0))).
Axiom thm_EXP_ZERO : forall n : nat, (Nat.pow (0) n) = (@COND nat (n = (0)) ((BIT1 0)) (0)).
Axiom thm_EXP_ADD : forall m : nat, forall n : nat, forall p : nat, (Nat.pow m (Nat.add n p)) = (Nat.mul (Nat.pow m n) (Nat.pow m p)).
Axiom thm_EXP_ONE : forall n : nat, (Nat.pow ((BIT1 0)) n) = ((BIT1 0)).
Axiom thm_EXP_1 : forall n : nat, (Nat.pow n ((BIT1 0))) = n.
Axiom thm_EXP_2 : forall n : nat, (Nat.pow n ((BIT0 (BIT1 0)))) = (Nat.mul n n).
...
Axiom thm_LE : (forall m : nat, (Peano.le m (0)) = (m = (0))) /\ (forall m : nat, forall n : nat, (Peano.le m (S n)) = ((m = (S n)) \/ (Peano.le m n))).
Axiom thm_LT : (forall m : nat, (Peano.lt m (0)) = False) /\ (forall m : nat, forall n : nat, (Peano.lt m (S n)) = ((m = n) \/ (Peano.lt m n))).
...
Axiom thm_LE_0 : forall n : nat, Peano.le (0) n.
Axiom thm_LT_0 : forall n : nat, Peano.lt (0) (S n).
...
Axiom thm_LT_NZ : forall n : nat, (Peano.lt (0) n) = (~ (n = (0))).
Axiom thm_LE_1 : (forall n : nat, (~ (n = (0))) -> Peano.lt (0) n) /\ ((forall n : nat, (~ (n = (0))) -> Peano.le ((BIT1 0)) n) /\ ((forall n : nat, (Peano.lt (0) n) -> ~ (n = (0))) /\ ((forall n : nat, (Peano.lt (0) n) -> Peano.le ((BIT1 0)) n) /\ ((forall n : nat, (Peano.le ((BIT1 0)) n) -> Peano.lt (0) n) /\ (forall n : nat, (Peano.le ((BIT1 0)) n) -> ~ (n = (0))))))).
...
Axiom thm_LT_ADD : forall m : nat, forall n : nat, (Peano.lt m (Nat.add m n)) = (Peano.lt (0) n).
Axiom thm_LT_ADDR : forall m : nat, forall n : nat, (Peano.lt n (Nat.add m n)) = (Peano.lt (0) m).
...
Axiom thm_LT_MULT : forall m : nat, forall n : nat, (Peano.lt (0) (Nat.mul m n)) = ((Peano.lt (0) m) /\ (Peano.lt (0) n)).
...
Axiom thm_LT_LMULT : forall m : nat, forall n : nat, forall p : nat, ((~ (m = (0))) /\ (Peano.lt n p)) -> Peano.lt (Nat.mul m n) (Nat.mul m p).
Axiom thm_LE_MULT_LCANCEL : forall m : nat, forall n : nat, forall p : nat, (Peano.le (Nat.mul m n) (Nat.mul m p)) = ((m = (0)) \/ (Peano.le n p)).
Axiom thm_LE_MULT_RCANCEL : forall m : nat, forall n : nat, forall p : nat, (Peano.le (Nat.mul m p) (Nat.mul n p)) = ((Peano.le m n) \/ (p = (0))).
Axiom thm_LT_MULT_LCANCEL : forall m : nat, forall n : nat, forall p : nat, (Peano.lt (Nat.mul m n) (Nat.mul m p)) = ((~ (m = (0))) /\ (Peano.lt n p)).
Axiom thm_LT_MULT_RCANCEL : forall m : nat, forall n : nat, forall p : nat, (Peano.lt (Nat.mul m p) (Nat.mul n p)) = ((Peano.lt m n) /\ (~ (p = (0)))).
...
Axiom thm_LT_POW2_REFL : forall n : nat, Peano.lt n (Nat.pow ((BIT0 (BIT1 0))) n).
...
Axiom thm_num_INDUCTION_DOWN : forall P : nat -> Prop, forall m : nat, ((forall n : nat, (Peano.le m n) -> P n) /\ (forall n : nat, ((Peano.lt n m) /\ (P (Nat.add n ((BIT1 0))))) -> P n)) -> forall n : nat, P n.
Axiom thm_EVEN : ((Stdlib.Arith.PeanoNat.Nat.Even (0)) = True) /\ (forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even (S n)) = (~ (Stdlib.Arith.PeanoNat.Nat.Even n))).
Axiom thm_ODD : ((Stdlib.Arith.PeanoNat.Nat.Odd (0)) = False) /\ (forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Odd (S n)) = (~ (Stdlib.Arith.PeanoNat.Nat.Odd n))).
...
Axiom thm_EVEN_EXP : forall m : nat, forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even (Nat.pow m n)) = ((Stdlib.Arith.PeanoNat.Nat.Even m) /\ (~ (n = (0)))).
...
Axiom thm_ODD_EXP : forall m : nat, forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Odd (Nat.pow m n)) = ((Stdlib.Arith.PeanoNat.Nat.Odd m) \/ (n = (0))).
Axiom thm_EVEN_DOUBLE : forall n : nat, Stdlib.Arith.PeanoNat.Nat.Even (Nat.mul ((BIT0 (BIT1 0))) n).
Axiom thm_ODD_DOUBLE : forall n : nat, Stdlib.Arith.PeanoNat.Nat.Odd (S (Nat.mul ((BIT0 (BIT1 0))) n)).
Axiom thm_EVEN_EXISTS_LEMMA : forall n : nat, ((Stdlib.Arith.PeanoNat.Nat.Even n) -> exists m : nat, n = (Nat.mul ((BIT0 (BIT1 0))) m)) /\ ((~ (Stdlib.Arith.PeanoNat.Nat.Even n)) -> exists m : nat, n = (S (Nat.mul ((BIT0 (BIT1 0))) m))).
Axiom thm_EVEN_EXISTS : forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even n) = (exists m : nat, n = (Nat.mul ((BIT0 (BIT1 0))) m)).
Axiom thm_ODD_EXISTS : forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Odd n) = (exists m : nat, n = (S (Nat.mul ((BIT0 (BIT1 0))) m))).
Axiom thm_EVEN_ODD_DECOMPOSITION : forall n : nat, (exists k : nat, exists m : nat, (Stdlib.Arith.PeanoNat.Nat.Odd m) /\ (n = (Nat.mul (Nat.pow ((BIT0 (BIT1 0))) k) m))) = (~ (n = (0))).
Axiom thm_SUB : (forall m : nat, (Nat.sub m (0)) = m) /\ (forall m : nat, forall n : nat, (Nat.sub m (S n)) = (Nat.pred (Nat.sub m n))).
Axiom thm_SUB_0 : forall m : nat, ((Nat.sub (0) m) = (0)) /\ ((Nat.sub m (0)) = m).
...
Axiom thm_SUB_REFL : forall n : nat, (Nat.sub n n) = (0).
...
Axiom thm_SUB_EQ_0 : forall m : nat, forall n : nat, ((Nat.sub m n) = (0)) = (Peano.le m n).
Axiom thm_ADD_SUBR2 : forall m : nat, forall n : nat, (Nat.sub m (Nat.add m n)) = (0).
Axiom thm_ADD_SUBR : forall m : nat, forall n : nat, (Nat.sub n (Nat.add m n)) = (0).
...
Axiom thm_SUC_SUB1 : forall n : nat, (Nat.sub (S n) ((BIT1 0))) = n.
...
Axiom thm_FACT : ((Factorial.fact (0)) = ((BIT1 0))) /\ (forall n : nat, (Factorial.fact (S n)) = (Nat.mul (S n) (Factorial.fact n))).
Axiom thm_FACT_LT : forall n : nat, Peano.lt (0) (Factorial.fact n).
Axiom thm_FACT_LE : forall n : nat, Peano.le ((BIT1 0)) (Factorial.fact n).
Axiom thm_FACT_NZ : forall n : nat, ~ ((Factorial.fact n) = (0)).
Axiom thm_FACT_MONO : forall m : nat, forall n : nat, (Peano.le m n) -> Peano.le (Factorial.fact m) (Factorial.fact n).
Axiom thm_EXP_LT_0 : forall n : nat, forall x : nat, (Peano.lt (0) (Nat.pow x n)) = ((~ (x = (0))) \/ (n = (0))).
Axiom thm_LT_EXP : forall x : nat, forall m : nat, forall n : nat, (Peano.lt (Nat.pow x m) (Nat.pow x n)) = (((Peano.le ((BIT0 (BIT1 0))) x) /\ (Peano.lt m n)) \/ ((x = (0)) /\ ((~ (m = (0))) /\ (n = (0))))).
Axiom thm_LE_EXP : forall x : nat, forall m : nat, forall n : nat, (Peano.le (Nat.pow x m) (Nat.pow x n)) = (@COND Prop (x = (0)) ((m = (0)) -> n = (0)) ((x = ((BIT1 0))) \/ (Peano.le m n))).
Axiom thm_EQ_EXP : forall x : nat, forall m : nat, forall n : nat, ((Nat.pow x m) = (Nat.pow x n)) = (@COND Prop (x = (0)) ((m = (0)) = (n = (0))) ((x = ((BIT1 0))) \/ (m = n))).
Axiom thm_EXP_MONO_LE_IMP : forall x : nat, forall y : nat, forall n : nat, (Peano.le x y) -> Peano.le (Nat.pow x n) (Nat.pow y n).
Axiom thm_EXP_MONO_LT_IMP : forall x : nat, forall y : nat, forall n : nat, ((Peano.lt x y) /\ (~ (n = (0)))) -> Peano.lt (Nat.pow x n) (Nat.pow y n).
Axiom thm_EXP_MONO_LE : forall x : nat, forall y : nat, forall n : nat, (Peano.le (Nat.pow x n) (Nat.pow y n)) = ((Peano.le x y) \/ (n = (0))).
Axiom thm_EXP_MONO_LT : forall x : nat, forall y : nat, forall n : nat, (Peano.lt (Nat.pow x n) (Nat.pow y n)) = ((Peano.lt x y) /\ (~ (n = (0)))).
Axiom thm_EXP_MONO_EQ : forall x : nat, forall y : nat, forall n : nat, ((Nat.pow x n) = (Nat.pow y n)) = ((x = y) \/ (n = (0))).
Axiom thm_DIVMOD_EXIST : forall m : nat, forall n : nat, (~ (n = (0))) -> exists q : nat, exists r : nat, (m = (Nat.add (Nat.mul q n) r)) /\ (Peano.lt r n).
Axiom thm_DIVMOD_EXIST_0 : forall m : nat, forall n : nat, exists q : nat, exists r : nat, @COND Prop (n = (0)) ((q = (0)) /\ (r = m)) ((m = (Nat.add (Nat.mul q n) r)) /\ (Peano.lt r n)).
Axiom thm_DIVISION : forall m : nat, forall n : nat, (~ (n = (0))) -> (m = (Nat.add (Nat.mul (Nat.div m n) n) (Nat.modulo m n))) /\ (Peano.lt (Nat.modulo m n) n).
Axiom thm_DIV_ZERO : forall n : nat, (Nat.div n (0)) = (0).
Axiom thm_MOD_ZERO : forall n : nat, (Nat.modulo n (0)) = n.
...
Axiom thm_MOD_LT_EQ : forall m : nat, forall n : nat, (Peano.lt (Nat.modulo m n) n) = (~ (n = (0))).
Axiom thm_MOD_LT_EQ_LT : forall m : nat, forall n : nat, (Peano.lt (Nat.modulo m n) n) = (Peano.lt (0) n).
...
Axiom thm_MOD_0 : forall n : nat, (Nat.modulo (0) n) = (0).
Axiom thm_DIV_0 : forall n : nat, (Nat.div (0) n) = (0).
Axiom thm_MOD_MULT : forall m : nat, forall n : nat, (Nat.modulo (Nat.mul m n) m) = (0).
Axiom thm_DIV_MULT : forall m : nat, forall n : nat, (~ (m = (0))) -> (Nat.div (Nat.mul m n) m) = n.
Axiom thm_MOD_LT : forall m : nat, forall n : nat, (Peano.lt m n) -> (Nat.modulo m n) = m.
Axiom thm_MOD_EQ_SELF : forall m : nat, forall n : nat, ((Nat.modulo m n) = m) = ((n = (0)) \/ (Peano.lt m n)).
Axiom thm_MOD_CASES : forall n : nat, forall p : nat, (Peano.lt n (Nat.mul ((BIT0 (BIT1 0))) p)) -> (Nat.modulo n p) = (@COND nat (Peano.lt n p) n (Nat.sub n p)).
...
Axiom thm_MOD_LE_TWICE : forall m : nat, forall n : nat, ((Peano.lt (0) m) /\ (Peano.le m n)) -> Peano.le (Nat.mul ((BIT0 (BIT1 0))) (Nat.modulo n m)) n.
Axiom thm_MOD_1 : forall n : nat, (Nat.modulo n ((BIT1 0))) = (0).
Axiom thm_DIV_1 : forall n : nat, (Nat.div n ((BIT1 0))) = n.
Axiom thm_DIV_LT : forall m : nat, forall n : nat, (Peano.lt m n) -> (Nat.div m n) = (0).
...
Axiom thm_MOD_MOD_LE : forall m : nat, forall n : nat, forall p : nat, ((~ (n = (0))) /\ (Peano.le n p)) -> (Nat.modulo (Nat.modulo m n) p) = (Nat.modulo m n).
Axiom thm_MOD_EVEN_2 : forall m : nat, forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even n) -> (Nat.modulo (Nat.modulo m n) ((BIT0 (BIT1 0)))) = (Nat.modulo m ((BIT0 (BIT1 0)))).
Axiom thm_DIV_MULT2 : forall m : nat, forall n : nat, forall p : nat, (~ (m = (0))) -> (Nat.div (Nat.mul m n) (Nat.mul m p)) = (Nat.div n p).
Axiom thm_MOD_MULT2 : forall m : nat, forall n : nat, forall p : nat, (Nat.modulo (Nat.mul m n) (Nat.mul m p)) = (Nat.mul m (Nat.modulo n p)).
Axiom thm_MOD_EXISTS : forall m : nat, forall n : nat, (exists q : nat, m = (Nat.mul n q)) = (@COND Prop (n = (0)) (m = (0)) ((Nat.modulo m n) = (0))).
Axiom thm_LE_RDIV_EQ : forall a : nat, forall b : nat, forall n : nat, (~ (a = (0))) -> (Peano.le n (Nat.div b a)) = (Peano.le (Nat.mul a n) b).
Axiom thm_RDIV_LT_EQ : forall a : nat, forall b : nat, forall n : nat, (~ (a = (0))) -> (Peano.lt (Nat.div b a) n) = (Peano.lt b (Nat.mul a n)).
Axiom thm_LE_LDIV_EQ : forall a : nat, forall b : nat, forall n : nat, (~ (a = (0))) -> (Peano.le (Nat.div b a) n) = (Peano.lt b (Nat.mul a (Nat.add n ((BIT1 0))))).
Axiom thm_LDIV_LT_EQ : forall a : nat, forall b : nat, forall n : nat, (~ (a = (0))) -> (Peano.lt n (Nat.div b a)) = (Peano.le (Nat.mul a (Nat.add n ((BIT1 0)))) b).
Axiom thm_LE_LDIV : forall a : nat, forall b : nat, forall n : nat, ((~ (a = (0))) /\ (Peano.le b (Nat.mul a n))) -> Peano.le (Nat.div b a) n.
Axiom thm_DIV_MONO : forall m : nat, forall n : nat, forall p : nat, (Peano.le m n) -> Peano.le (Nat.div m p) (Nat.div n p).
Axiom thm_DIV_MONO_LT : forall m : nat, forall n : nat, forall p : nat, ((~ (p = (0))) /\ (Peano.le (Nat.add m p) n)) -> Peano.lt (Nat.div m p) (Nat.div n p).
Axiom thm_DIV_EQ_0 : forall m : nat, forall n : nat, (~ (n = (0))) -> ((Nat.div m n) = (0)) = (Peano.lt m n).
Axiom thm_MOD_DIV_EQ_0 : forall m : nat, forall n : nat, (~ (n = (0))) -> (Nat.div (Nat.modulo m n) n) = (0).
Axiom thm_MOD_EQ_0 : forall m : nat, forall n : nat, ((Nat.modulo m n) = (0)) = (exists q : nat, m = (Nat.mul q n)).
Axiom thm_DIV_EQ_SELF : forall m : nat, forall n : nat, ((Nat.div m n) = m) = ((m = (0)) \/ (n = ((BIT1 0)))).
Axiom thm_MOD_REFL : forall n : nat, (Nat.modulo n n) = (0).
Axiom thm_EVEN_MOD : forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even n) = ((Nat.modulo n ((BIT0 (BIT1 0)))) = (0)).
Axiom thm_ODD_MOD : forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Odd n) = ((Nat.modulo n ((BIT0 (BIT1 0)))) = ((BIT1 0))).
Axiom thm_MOD_2_CASES : forall n : nat, (Nat.modulo n ((BIT0 (BIT1 0)))) = (@COND nat (Stdlib.Arith.PeanoNat.Nat.Even n) (0) ((BIT1 0))).
...
Axiom thm_HALF_DOUBLE : (forall n : nat, (Nat.div (Nat.mul ((BIT0 (BIT1 0))) n) ((BIT0 (BIT1 0)))) = n) /\ (forall n : nat, (Nat.div (Nat.mul n ((BIT0 (BIT1 0)))) ((BIT0 (BIT1 0)))) = n).
Axiom thm_DOUBLE_HALF : (forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even n) -> (Nat.mul ((BIT0 (BIT1 0))) (Nat.div n ((BIT0 (BIT1 0))))) = n) /\ (forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even n) -> (Nat.mul (Nat.div n ((BIT0 (BIT1 0)))) ((BIT0 (BIT1 0)))) = n).
...
Axiom thm_DIV_MULT_ADD : (forall a : nat, forall b : nat, forall n : nat, (~ (n = (0))) -> (Nat.div (Nat.add (Nat.mul a n) b) n) = (Nat.add a (Nat.div b n))) /\ ((forall a : nat, forall b : nat, forall n : nat, (~ (n = (0))) -> (Nat.div (Nat.add (Nat.mul n a) b) n) = (Nat.add a (Nat.div b n))) /\ ((forall a : nat, forall b : nat, forall n : nat, (~ (n = (0))) -> (Nat.div (Nat.add b (Nat.mul a n)) n) = (Nat.add (Nat.div b n) a)) /\ (forall a : nat, forall b : nat, forall n : nat, (~ (n = (0))) -> (Nat.div (Nat.add b (Nat.mul n a)) n) = (Nat.add (Nat.div b n) a)))).
...
Axiom thm_DIV_ADD_MOD : forall a : nat, forall b : nat, forall n : nat, (~ (n = (0))) -> ((Nat.modulo (Nat.add a b) n) = (Nat.add (Nat.modulo a n) (Nat.modulo b n))) = ((Nat.div (Nat.add a b) n) = (Nat.add (Nat.div a n) (Nat.div b n))).
Axiom thm_MOD_ADD_EQ_EQ : forall n : nat, forall x : nat, forall y : nat, ((Nat.modulo (Nat.add x y) n) = (Nat.add (Nat.modulo x n) (Nat.modulo y n))) = ((n = (0)) \/ (Peano.lt (Nat.add (Nat.modulo x n) (Nat.modulo y n)) n)).
Axiom thm_DIV_ADD_EQ_EQ : forall n : nat, forall x : nat, forall y : nat, ((Nat.div (Nat.add x y) n) = (Nat.add (Nat.div x n) (Nat.div y n))) = ((n = (0)) \/ (Peano.lt (Nat.add (Nat.modulo x n) (Nat.modulo y n)) n)).
...
Axiom thm_DIV_REFL : forall n : nat, (~ (n = (0))) -> (Nat.div n n) = ((BIT1 0)).
Axiom thm_MOD_LE : forall m : nat, forall n : nat, Peano.le (Nat.modulo m n) m.
Axiom thm_DIV_MONO2 : forall m : nat, forall n : nat, forall p : nat, ((~ (p = (0))) /\ (Peano.le p m)) -> Peano.le (Nat.div n m) (Nat.div n p).
Axiom thm_DIV_LE_EXCLUSION : forall a : nat, forall b : nat, forall c : nat, forall d : nat, ((~ (b = (0))) /\ (Peano.lt (Nat.mul b c) (Nat.mul (Nat.add a ((BIT1 0))) d))) -> Peano.le (Nat.div c d) (Nat.div a b).
Axiom thm_DIV_EQ_EXCLUSION : forall a : nat, forall b : nat, forall c : nat, forall d : nat, ((Peano.lt (Nat.mul b c) (Nat.mul (Nat.add a ((BIT1 0))) d)) /\ (Peano.lt (Nat.mul a d) (Nat.mul (Nat.add c ((BIT1 0))) b))) -> (Nat.div a b) = (Nat.div c d).
...
Axiom thm_MOD_EXP : forall m : nat, forall n : nat, forall p : nat, (~ (m = (0))) -> (Nat.modulo (Nat.pow m n) (Nat.pow m p)) = (@COND nat ((Peano.le p n) \/ (m = ((BIT1 0)))) (0) (Nat.pow m n)).
Axiom thm_DIV_EXP : forall m : nat, forall n : nat, forall p : nat, (~ (m = (0))) -> (Nat.div (Nat.pow m n) (Nat.pow m p)) = (@COND nat (Peano.le p n) (Nat.pow m (Nat.sub n p)) (@COND nat (m = ((BIT1 0))) ((BIT1 0)) (0))).
Axiom thm_FORALL_LT_MOD_THM : forall P : nat -> Prop, forall n : nat, (forall a : nat, (Peano.lt a n) -> P a) = ((n = (0)) \/ (forall a : nat, P (Nat.modulo a n))).
Axiom thm_FORALL_MOD_THM : forall P : nat -> Prop, forall n : nat, (~ (n = (0))) -> (forall a : nat, P (Nat.modulo a n)) = (forall a : nat, (Peano.lt a n) -> P a).
Axiom thm_EXISTS_LT_MOD_THM : forall P : nat -> Prop, forall n : nat, (exists a : nat, (Peano.lt a n) /\ (P a)) = ((~ (n = (0))) /\ (exists a : nat, P (Nat.modulo a n))).
Axiom thm_EXISTS_MOD_THM : forall P : nat -> Prop, forall n : nat, (~ (n = (0))) -> (exists a : nat, P (Nat.modulo a n)) = (exists a : nat, (Peano.lt a n) /\ (P a)).
Axiom thm_PRE_ELIM_THM : forall (n : nat) (P : nat -> Prop), (P (Nat.pred n)) = (forall m : nat, ((n = (S m)) \/ ((m = (0)) /\ (n = (0)))) -> P m).
Axiom thm_SUB_ELIM_THM : forall (a : nat) (b : nat) (P : nat -> Prop), (P (Nat.sub a b)) = (forall d : nat, ((a = (Nat.add b d)) \/ ((Peano.lt a b) /\ (d = (0)))) -> P d).
Axiom thm_DIVMOD_ELIM_THM : forall (m : nat) (n : nat) (P : nat -> nat -> Prop), (P (Nat.div m n) (Nat.modulo m n)) = (forall q : nat, forall r : nat, (((n = (0)) /\ ((q = (0)) /\ (r = m))) \/ ((m = (Nat.add (Nat.mul q n) r)) /\ (Peano.lt r n))) -> P q r).
...
Axiom thm_DEPENDENT_CHOICE_FIXED : forall {A : Type'}, forall P : nat -> A -> Prop, forall R' : nat -> A -> A -> Prop, forall a : A, ((P (0) a) /\ (forall n : nat, forall x : A, (P n x) -> exists y : A, (P (S n) y) /\ (R' n x y))) -> exists f : nat -> A, ((f (0)) = a) /\ ((forall n : nat, P n (f n)) /\ (forall n : nat, R' n (f n) (f (S n)))).
Axiom thm_DEPENDENT_CHOICE : forall {A : Type'}, forall P : nat -> A -> Prop, forall R' : nat -> A -> A -> Prop, ((exists a : A, P (0) a) /\ (forall n : nat, forall x : A, (P n x) -> exists y : A, (P (S n) y) /\ (R' n x y))) -> exists f : nat -> A, (forall n : nat, P n (f n)) /\ (forall n : nat, R' n (f n) (f (S n))).
...
Axiom thm_ARITH_ZERO : (((0)) = (0)) /\ ((BIT0 0) = 0).
Axiom thm_BIT0_0 : (BIT0 (0)) = (0).
Axiom thm_BIT1_0 : (BIT1 (0)) = ((BIT1 0)).
Axiom thm_ARITH_SUC : (forall n : nat, (S (n)) = ((S n))) /\ (((S 0) = (BIT1 0)) /\ ((forall n : nat, (S (BIT0 n)) = (BIT1 n)) /\ (forall n : nat, (S (BIT1 n)) = (BIT0 (S n))))).
Axiom thm_ARITH_PRE : (forall n : nat, (Nat.pred (n)) = ((Nat.pred n))) /\ (((Nat.pred 0) = 0) /\ ((forall n : nat, (Nat.pred (BIT0 n)) = (@COND nat (n = 0) 0 (BIT1 (Nat.pred n)))) /\ (forall n : nat, (Nat.pred (BIT1 n)) = (BIT0 n)))).
Axiom thm_ARITH_ADD : (forall m : nat, forall n : nat, (Nat.add (m) (n)) = ((Nat.add m n))) /\ (((Nat.add 0 0) = 0) /\ ((forall n : nat, (Nat.add 0 (BIT0 n)) = (BIT0 n)) /\ ((forall n : nat, (Nat.add 0 (BIT1 n)) = (BIT1 n)) /\ ((forall n : nat, (Nat.add (BIT0 n) 0) = (BIT0 n)) /\ ((forall n : nat, (Nat.add (BIT1 n) 0) = (BIT1 n)) /\ ((forall m : nat, forall n : nat, (Nat.add (BIT0 m) (BIT0 n)) = (BIT0 (Nat.add m n))) /\ ((forall m : nat, forall n : nat, (Nat.add (BIT0 m) (BIT1 n)) = (BIT1 (Nat.add m n))) /\ ((forall m : nat, forall n : nat, (Nat.add (BIT1 m) (BIT0 n)) = (BIT1 (Nat.add m n))) /\ (forall m : nat, forall n : nat, (Nat.add (BIT1 m) (BIT1 n)) = (BIT0 (S (Nat.add m n)))))))))))).
Axiom thm_ARITH_MULT : (forall m : nat, forall n : nat, (Nat.mul (m) (n)) = ((Nat.mul m n))) /\ (((Nat.mul 0 0) = 0) /\ ((forall n : nat, (Nat.mul 0 (BIT0 n)) = 0) /\ ((forall n : nat, (Nat.mul 0 (BIT1 n)) = 0) /\ ((forall n : nat, (Nat.mul (BIT0 n) 0) = 0) /\ ((forall n : nat, (Nat.mul (BIT1 n) 0) = 0) /\ ((forall m : nat, forall n : nat, (Nat.mul (BIT0 m) (BIT0 n)) = (BIT0 (BIT0 (Nat.mul m n)))) /\ ((forall m : nat, forall n : nat, (Nat.mul (BIT0 m) (BIT1 n)) = (Nat.add (BIT0 m) (BIT0 (BIT0 (Nat.mul m n))))) /\ ((forall m : nat, forall n : nat, (Nat.mul (BIT1 m) (BIT0 n)) = (Nat.add (BIT0 n) (BIT0 (BIT0 (Nat.mul m n))))) /\ (forall m : nat, forall n : nat, (Nat.mul (BIT1 m) (BIT1 n)) = (Nat.add (BIT1 m) (Nat.add (BIT0 n) (BIT0 (BIT0 (Nat.mul m n)))))))))))))).
Axiom thm_ARITH_EXP : (forall m : nat, forall n : nat, (Nat.pow (m) (n)) = ((Nat.pow m n))) /\ (((Nat.pow 0 0) = (BIT1 0)) /\ ((forall m : nat, (Nat.pow (BIT0 m) 0) = (BIT1 0)) /\ ((forall m : nat, (Nat.pow (BIT1 m) 0) = (BIT1 0)) /\ ((forall n : nat, (Nat.pow 0 (BIT0 n)) = (Nat.mul (Nat.pow 0 n) (Nat.pow 0 n))) /\ ((forall m : nat, forall n : nat, (Nat.pow (BIT0 m) (BIT0 n)) = (Nat.mul (Nat.pow (BIT0 m) n) (Nat.pow (BIT0 m) n))) /\ ((forall m : nat, forall n : nat, (Nat.pow (BIT1 m) (BIT0 n)) = (Nat.mul (Nat.pow (BIT1 m) n) (Nat.pow (BIT1 m) n))) /\ ((forall n : nat, (Nat.pow 0 (BIT1 n)) = 0) /\ ((forall m : nat, forall n : nat, (Nat.pow (BIT0 m) (BIT1 n)) = (Nat.mul (BIT0 m) (Nat.mul (Nat.pow (BIT0 m) n) (Nat.pow (BIT0 m) n)))) /\ (forall m : nat, forall n : nat, (Nat.pow (BIT1 m) (BIT1 n)) = (Nat.mul (BIT1 m) (Nat.mul (Nat.pow (BIT1 m) n) (Nat.pow (BIT1 m) n)))))))))))).
Axiom thm_ARITH_EVEN : (forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even (n)) = (Stdlib.Arith.PeanoNat.Nat.Even n)) /\ (((Stdlib.Arith.PeanoNat.Nat.Even 0) = True) /\ ((forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even (BIT0 n)) = True) /\ (forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even (BIT1 n)) = False))).
Axiom thm_ARITH_ODD : (forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Odd (n)) = (Stdlib.Arith.PeanoNat.Nat.Odd n)) /\ (((Stdlib.Arith.PeanoNat.Nat.Odd 0) = False) /\ ((forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Odd (BIT0 n)) = False) /\ (forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Odd (BIT1 n)) = True))).
Axiom thm_ARITH_LE : (forall m : nat, forall n : nat, (Peano.le (m) (n)) = (Peano.le m n)) /\ (((Peano.le 0 0) = True) /\ ((forall n : nat, (Peano.le (BIT0 n) 0) = (Peano.le n 0)) /\ ((forall n : nat, (Peano.le (BIT1 n) 0) = False) /\ ((forall n : nat, (Peano.le 0 (BIT0 n)) = True) /\ ((forall n : nat, (Peano.le 0 (BIT1 n)) = True) /\ ((forall m : nat, forall n : nat, (Peano.le (BIT0 m) (BIT0 n)) = (Peano.le m n)) /\ ((forall m : nat, forall n : nat, (Peano.le (BIT0 m) (BIT1 n)) = (Peano.le m n)) /\ ((forall m : nat, forall n : nat, (Peano.le (BIT1 m) (BIT0 n)) = (Peano.lt m n)) /\ (forall m : nat, forall n : nat, (Peano.le (BIT1 m) (BIT1 n)) = (Peano.le m n)))))))))).
Axiom thm_ARITH_LT : (forall m : nat, forall n : nat, (Peano.lt (m) (n)) = (Peano.lt m n)) /\ (((Peano.lt 0 0) = False) /\ ((forall n : nat, (Peano.lt (BIT0 n) 0) = False) /\ ((forall n : nat, (Peano.lt (BIT1 n) 0) = False) /\ ((forall n : nat, (Peano.lt 0 (BIT0 n)) = (Peano.lt 0 n)) /\ ((forall n : nat, (Peano.lt 0 (BIT1 n)) = True) /\ ((forall m : nat, forall n : nat, (Peano.lt (BIT0 m) (BIT0 n)) = (Peano.lt m n)) /\ ((forall m : nat, forall n : nat, (Peano.lt (BIT0 m) (BIT1 n)) = (Peano.le m n)) /\ ((forall m : nat, forall n : nat, (Peano.lt (BIT1 m) (BIT0 n)) = (Peano.lt m n)) /\ (forall m : nat, forall n : nat, (Peano.lt (BIT1 m) (BIT1 n)) = (Peano.lt m n)))))))))).
Axiom thm_ARITH_EQ : (forall m : nat, forall n : nat, ((m) = (n)) = (m = n)) /\ (((0 = 0) = True) /\ ((forall n : nat, ((BIT0 n) = 0) = (n = 0)) /\ ((forall n : nat, ((BIT1 n) = 0) = False) /\ ((forall n : nat, (0 = (BIT0 n)) = (0 = n)) /\ ((forall n : nat, (0 = (BIT1 n)) = False) /\ ((forall m : nat, forall n : nat, ((BIT0 m) = (BIT0 n)) = (m = n)) /\ ((forall m : nat, forall n : nat, ((BIT0 m) = (BIT1 n)) = False) /\ ((forall m : nat, forall n : nat, ((BIT1 m) = (BIT0 n)) = False) /\ (forall m : nat, forall n : nat, ((BIT1 m) = (BIT1 n)) = (m = n)))))))))).
Axiom thm_ARITH_SUB : (forall m : nat, forall n : nat, (Nat.sub (m) (n)) = ((Nat.sub m n))) /\ (((Nat.sub 0 0) = 0) /\ ((forall n : nat, (Nat.sub 0 (BIT0 n)) = 0) /\ ((forall n : nat, (Nat.sub 0 (BIT1 n)) = 0) /\ ((forall n : nat, (Nat.sub (BIT0 n) 0) = (BIT0 n)) /\ ((forall n : nat, (Nat.sub (BIT1 n) 0) = (BIT1 n)) /\ ((forall m : nat, forall n : nat, (Nat.sub (BIT0 m) (BIT0 n)) = (BIT0 (Nat.sub m n))) /\ ((forall m : nat, forall n : nat, (Nat.sub (BIT0 m) (BIT1 n)) = (Nat.pred (BIT0 (Nat.sub m n)))) /\ ((forall m : nat, forall n : nat, (Nat.sub (BIT1 m) (BIT0 n)) = (@COND nat (Peano.le n m) (BIT1 (Nat.sub m n)) 0)) /\ (forall m : nat, forall n : nat, (Nat.sub (BIT1 m) (BIT1 n)) = (BIT0 (Nat.sub m n))))))))))).
Axiom thm_EXP_2_NE_0 : forall n : nat, ~ ((Nat.pow ((BIT0 (BIT1 0))) n) = (0)).
...
Axiom thm_NUMPAIR : forall x : nat, forall y : nat, (NUMPAIR x y) = (Nat.mul (Nat.pow ((BIT0 (BIT1 0))) x) (Nat.add (Nat.mul ((BIT0 (BIT1 0))) y) ((BIT1 0)))).
...
Axiom thm_NUMSUM : forall b : Prop, forall x : nat, (NUMSUM b x) = (@COND nat b (S (Nat.mul ((BIT0 (BIT1 0))) x)) (Nat.mul ((BIT0 (BIT1 0))) x)).
...
Axiom thm_ZBOT : forall {A : Type'}, (@ZBOT A) = (@INJP A (@INJN A (0)) (@ε (nat -> A -> Prop) (fun z : nat -> A -> Prop => True))).
...
Axiom thm_FCONS : forall {A : Type'}, (forall a : A, forall f : nat -> A, (@FCONS A a f (0)) = a) /\ (forall a : A, forall f : nat -> A, forall n : nat, (@FCONS A a f (S n)) = (f n)).
Axiom thm_FCONS_UNDO : forall {A : Type'}, forall f : nat -> A, f = (@FCONS A (f (0)) (@o nat nat A f S)).
...
Axiom thm_LENGTH : forall {A : Type'}, ((@List.length A (@nil A)) = (0)) /\ (forall h : A, forall t : list A, (@List.length A (@cons A h t)) = (S (@List.length A t))).
...
Axiom thm_REPLICATE : forall {A : Type'} (n : nat) (x : A), ((@repeat_with_perm_args A (0) x) = (@nil A)) /\ ((@repeat_with_perm_args A (S n) x) = (@cons A x (@repeat_with_perm_args A n x))).
...
Axiom thm_EL : forall {A : Type'} (n : nat) (l : list A), ((@EL A (0) l) = (@hd A l)) /\ ((@EL A (S n) l) = (@EL A n (@tl A l))).
...
Axiom thm_list_of_seq : forall {A : Type'} (s : nat -> A) (n : nat), ((@list_of_seq A s (0)) = (@nil A)) /\ ((@list_of_seq A s (S n)) = (@List.app A (@list_of_seq A s n) (@cons A (s n) (@nil A)))).
...
Axiom thm_LENGTH_EQ_NIL : forall {A : Type'}, forall l : list A, ((@List.length A l) = (0)) = (l = (@nil A)).
...
Axiom thm_MEM_REPLICATE : forall {A : Type'}, forall n : nat, forall x : A, forall y : A, (@List.In A x (@repeat_with_perm_args A n y)) = ((x = y) /\ (~ (n = (0)))).
...
Axiom thm_LENGTH_TL : forall {A : Type'}, forall l : list A, (~ (l = (@nil A))) -> (@List.length A (@tl A l)) = (Nat.sub (@List.length A l) ((BIT1 0))).
...
Axiom thm_EL_TL : forall {A : Type'} (l : list A), forall n : nat, (@EL A n (@tl A l)) = (@EL A (Nat.add n ((BIT1 0))) l).
Axiom thm_EL_CONS : forall {A : Type'}, forall n : nat, forall h : A, forall t : list A, (@EL A n (@cons A h t)) = (@COND A (n = (0)) h (@EL A (Nat.sub n ((BIT1 0))) t)).
Axiom thm_LAST_EL : forall {A : Type'}, forall l : list A, (~ (l = (@nil A))) -> (@LAST A l) = (@EL A (Nat.sub (@List.length A l) ((BIT1 0))) l).
...
Axiom thm_LIST_OF_SEQ_EQ_NIL : forall {A : Type'}, forall s : nat -> A, forall n : nat, ((@list_of_seq A s n) = (@nil A)) = (n = (0)).
...
Axiom thm_DIST_REFL : forall n : nat, (dist (@pair nat nat n n)) = (0).
Axiom thm_DIST_LZERO : forall n : nat, (dist (@pair nat nat (0) n)) = n.
Axiom thm_DIST_RZERO : forall n : nat, (dist (@pair nat nat n (0))) = n.
...
Axiom thm_DIST_EQ_0 : forall m : nat, forall n : nat, ((dist (@pair nat nat m n)) = (0)) = (m = n).
...
Axiom thm_BOUNDS_LINEAR_0 : forall A : nat, forall B : nat, (forall n : nat, Peano.le (Nat.mul A n) B) = (A = (0)).
...
Axiom thm_BOUNDS_NOTZERO : forall P : nat -> nat -> nat, forall A : nat, forall B : nat, (((P (0) (0)) = (0)) /\ (forall m : nat, forall n : nat, Peano.le (P m n) (Nat.add (Nat.mul A (Nat.add m n)) B))) -> exists B' : nat, forall m : nat, forall n : nat, Peano.le (P m n) (Nat.mul B' (Nat.add m n)).
...
Axiom thm_is_nadd_0 : is_nadd (fun n : nat => 0).
...
Axiom thm_NADD_LE_TOTAL_LEMMA : forall x : nadd, forall y : nadd, (~ (nadd_le x y)) -> forall B : nat, exists n : nat, (~ (n = (0))) /\ (Peano.lt (Nat.add (dest_nadd y n) B) (dest_nadd x n)).
...
Axiom thm_NADD_ADD_LID : forall x : nadd, nadd_eq (nadd_add (nadd_of_num (0)) x) x.
...
Axiom thm_NADD_MUL_LID : forall x : nadd, nadd_eq (nadd_mul (nadd_of_num ((BIT1 0))) x) x.
...
Axiom thm_NADD_LE_0 : forall x : nadd, nadd_le (nadd_of_num (0)) x.
...
Axiom thm_NADD_ARCH_MULT : forall x : nadd, forall k : nat, (~ (nadd_eq x (nadd_of_num (0)))) -> exists N' : nat, nadd_le (nadd_of_num k) (nadd_mul (nadd_of_num N') x).
Axiom thm_NADD_ARCH_ZERO : forall x : nadd, forall k : nadd, (forall n : nat, nadd_le (nadd_mul (nadd_of_num n) x) k) -> nadd_eq x (nadd_of_num (0)).
...
Axiom thm_NADD_NONZERO : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists N' : nat, forall n : nat, (Peano.le N' n) -> ~ ((dest_nadd x n) = (0)).
Axiom thm_NADD_LBOUND : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists A : nat, exists N' : nat, forall n : nat, (Peano.le N' n) -> Peano.le n (Nat.mul A (dest_nadd x n)).
Axiom thm_nadd_rinv : forall x : nadd, (nadd_rinv x) = (fun n : nat => Nat.div (Nat.mul n n) (dest_nadd x n)).
Axiom thm_NADD_MUL_LINV_LEMMA0 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists A : nat, exists B : nat, forall n : nat, Peano.le (nadd_rinv x n) (Nat.add (Nat.mul A n) B).
Axiom thm_NADD_MUL_LINV_LEMMA1 : forall x : nadd, forall n : nat, (~ ((dest_nadd x n) = (0))) -> Peano.le (dist (@pair nat nat (Nat.mul (dest_nadd x n) (nadd_rinv x n)) (Nat.mul n n))) (dest_nadd x n).
Axiom thm_NADD_MUL_LINV_LEMMA2 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists N' : nat, forall n : nat, (Peano.le N' n) -> Peano.le (dist (@pair nat nat (Nat.mul (dest_nadd x n) (nadd_rinv x n)) (Nat.mul n n))) (dest_nadd x n).
Axiom thm_NADD_MUL_LINV_LEMMA3 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists N' : nat, forall m : nat, forall n : nat, (Peano.le N' n) -> Peano.le (dist (@pair nat nat (Nat.mul m (Nat.mul (dest_nadd x m) (Nat.mul (dest_nadd x n) (nadd_rinv x n)))) (Nat.mul m (Nat.mul (dest_nadd x m) (Nat.mul n n))))) (Nat.mul m (Nat.mul (dest_nadd x m) (dest_nadd x n))).
Axiom thm_NADD_MUL_LINV_LEMMA4 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists N' : nat, forall m : nat, forall n : nat, ((Peano.le N' m) /\ (Peano.le N' n)) -> Peano.le (Nat.mul (Nat.mul (dest_nadd x m) (dest_nadd x n)) (dist (@pair nat nat (Nat.mul m (nadd_rinv x n)) (Nat.mul n (nadd_rinv x m))))) (Nat.add (Nat.mul (Nat.mul m n) (dist (@pair nat nat (Nat.mul m (dest_nadd x n)) (Nat.mul n (dest_nadd x m))))) (Nat.mul (Nat.mul (dest_nadd x m) (dest_nadd x n)) (Nat.add m n))).
Axiom thm_NADD_MUL_LINV_LEMMA5 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists B : nat, exists N' : nat, forall m : nat, forall n : nat, ((Peano.le N' m) /\ (Peano.le N' n)) -> Peano.le (Nat.mul (Nat.mul (dest_nadd x m) (dest_nadd x n)) (dist (@pair nat nat (Nat.mul m (nadd_rinv x n)) (Nat.mul n (nadd_rinv x m))))) (Nat.mul B (Nat.mul (Nat.mul m n) (Nat.add m n))).
Axiom thm_NADD_MUL_LINV_LEMMA6 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists B : nat, exists N' : nat, forall m : nat, forall n : nat, ((Peano.le N' m) /\ (Peano.le N' n)) -> Peano.le (Nat.mul (Nat.mul m n) (dist (@pair nat nat (Nat.mul m (nadd_rinv x n)) (Nat.mul n (nadd_rinv x m))))) (Nat.mul B (Nat.mul (Nat.mul m n) (Nat.add m n))).
Axiom thm_NADD_MUL_LINV_LEMMA7 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists B : nat, exists N' : nat, forall m : nat, forall n : nat, ((Peano.le N' m) /\ (Peano.le N' n)) -> Peano.le (dist (@pair nat nat (Nat.mul m (nadd_rinv x n)) (Nat.mul n (nadd_rinv x m)))) (Nat.mul B (Nat.add m n)).
Axiom thm_NADD_MUL_LINV_LEMMA7a : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> forall N' : nat, exists A : nat, exists B : nat, forall m : nat, forall n : nat, (Peano.le m N') -> Peano.le (dist (@pair nat nat (Nat.mul m (nadd_rinv x n)) (Nat.mul n (nadd_rinv x m)))) (Nat.add (Nat.mul A n) B).
Axiom thm_NADD_MUL_LINV_LEMMA8 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> exists B : nat, forall m : nat, forall n : nat, Peano.le (dist (@pair nat nat (Nat.mul m (nadd_rinv x n)) (Nat.mul n (nadd_rinv x m)))) (Nat.mul B (Nat.add m n)).
Axiom thm_nadd_inv : forall x : nadd, (nadd_inv x) = (@COND nadd (nadd_eq x (nadd_of_num (0))) (nadd_of_num (0)) (mk_nadd (nadd_rinv x))).
Axiom thm_NADD_INV : forall x : nadd, (dest_nadd (nadd_inv x)) = (@COND (nat -> nat) (nadd_eq x (nadd_of_num (0))) (fun n : nat => 0) (nadd_rinv x)).
Axiom thm_NADD_MUL_LINV : forall x : nadd, (~ (nadd_eq x (nadd_of_num (0)))) -> nadd_eq (nadd_mul (nadd_inv x) x) (nadd_of_num ((BIT1 0))).
Axiom thm_NADD_INV_0 : nadd_eq (nadd_inv (nadd_of_num (0))) (nadd_of_num (0)).
...
Axiom thm_HREAL_ADD_LID : forall x : hreal, (hreal_add (hreal_of_num (0)) x) = x.
...
Axiom thm_HREAL_MUL_LID : forall x : hreal, (hreal_mul (hreal_of_num ((BIT1 0))) x) = x.
...
Axiom thm_HREAL_MUL_LINV : forall x : hreal, (~ (x = (hreal_of_num (0)))) -> (hreal_mul (hreal_inv x) x) = (hreal_of_num ((BIT1 0))).
Axiom thm_HREAL_INV_0 : (hreal_inv (hreal_of_num (0))) = (hreal_of_num (0)).
...
Axiom thm_HREAL_ADD_RID : forall n : hreal, (hreal_add n (hreal_of_num (0))) = n.
...
Axiom thm_HREAL_MUL_LZERO : forall m : hreal, (hreal_mul (hreal_of_num (0)) m) = (hreal_of_num (0)).
Axiom thm_HREAL_MUL_RZERO : forall m : hreal, (hreal_mul m (hreal_of_num (0))) = (hreal_of_num (0)).
...
Axiom thm_treal_of_num : forall n : nat, (treal_of_num n) = (@pair hreal hreal (hreal_of_num n) (hreal_of_num (0))).
...
Axiom thm_treal_inv : forall y : hreal, forall x : hreal, (treal_inv (@pair hreal hreal x y)) = (@COND (prod hreal hreal) (x = y) (@pair hreal hreal (hreal_of_num (0)) (hreal_of_num (0))) (@COND (prod hreal hreal) (hreal_le y x) (@pair hreal hreal (hreal_inv (@ε hreal (fun d : hreal => x = (hreal_add y d)))) (hreal_of_num (0))) (@pair hreal hreal (hreal_of_num (0)) (hreal_inv (@ε hreal (fun d : hreal => y = (hreal_add x d))))))).
...
Axiom thm_TREAL_ADD_LID : forall x : prod hreal hreal, treal_eq (treal_add (treal_of_num (0)) x) x.
Axiom thm_TREAL_ADD_LINV : forall x : prod hreal hreal, treal_eq (treal_add (treal_neg x) x) (treal_of_num (0)).
...
Axiom thm_TREAL_MUL_LID : forall x : prod hreal hreal, treal_eq (treal_mul (treal_of_num ((BIT1 0))) x) x.
...
Axiom thm_TREAL_LE_MUL : forall x : prod hreal hreal, forall y : prod hreal hreal, ((treal_le (treal_of_num (0)) x) /\ (treal_le (treal_of_num (0)) y)) -> treal_le (treal_of_num (0)) (treal_mul x y).
Axiom thm_TREAL_INV_0 : treal_eq (treal_inv (treal_of_num (0))) (treal_of_num (0)).
Axiom thm_TREAL_MUL_LINV : forall x : prod hreal hreal, (~ (treal_eq x (treal_of_num (0)))) -> treal_eq (treal_mul (treal_inv x) x) (treal_of_num ((BIT1 0))).
...
Axiom thm_REAL_ADD_LID : forall x : real, (real_add (real_of_num (0)) x) = x.
Axiom thm_REAL_ADD_LINV : forall x : real, (real_add (real_neg x) x) = (real_of_num (0)).
...
Axiom thm_REAL_MUL_LID : forall x : real, (real_mul (real_of_num ((BIT1 0))) x) = x.
...
Axiom thm_REAL_LE_MUL : forall x : real, forall y : real, ((real_le (real_of_num (0)) x) /\ (real_le (real_of_num (0)) y)) -> real_le (real_of_num (0)) (real_mul x y).
Axiom thm_REAL_INV_0 : (real_inv (real_of_num (0))) = (real_of_num (0)).
Axiom thm_REAL_MUL_LINV : forall x : real, (~ (x = (real_of_num (0)))) -> (real_mul (real_inv x) x) = (real_of_num ((BIT1 0))).
...
Axiom thm_real_abs : forall x : real, (real_abs x) = (@COND real (real_le (real_of_num (0)) x) x (real_neg x)).
Axiom thm_real_pow : forall (x : real), ((real_pow x (0)) = (real_of_num ((BIT1 0)))) /\ (forall n : nat, (real_pow x (S n)) = (real_mul x (real_pow x n))).
...
Axiom thm_REAL_HREAL_LEMMA1 : exists r : hreal -> real, (forall x : real, (real_le (real_of_num (0)) x) = (exists y : hreal, x = (r y))) /\ (forall y : hreal, forall z : hreal, (hreal_le y z) = (real_le (r y) (r z))).
Axiom thm_REAL_HREAL_LEMMA2 : exists h : real -> hreal, exists r : hreal -> real, (forall x : hreal, (h (r x)) = x) /\ ((forall x : real, (real_le (real_of_num (0)) x) -> (r (h x)) = x) /\ ((forall x : hreal, real_le (real_of_num (0)) (r x)) /\ (forall x : hreal, forall y : hreal, (hreal_le x y) = (real_le (r x) (r y))))).
Axiom thm_REAL_COMPLETE_SOMEPOS : forall P : real -> Prop, ((exists x : real, (P x) /\ (real_le (real_of_num (0)) x)) /\ (exists M : real, forall x : real, (P x) -> real_le x M)) -> exists M : real, (forall x : real, (P x) -> real_le x M) /\ (forall M' : real, (forall x : real, (P x) -> real_le x M') -> real_le M M').
...
Axiom thm_REAL_ADD_RINV : forall x : real, (real_add x (real_neg x)) = (real_of_num (0)).
...
Axiom thm_REAL_MUL_RZERO : forall x : real, (real_mul x (real_of_num (0))) = (real_of_num (0)).
Axiom thm_REAL_MUL_LZERO : forall x : real, (real_mul (real_of_num (0)) x) = (real_of_num (0)).
...
Axiom thm_REAL_ADD_RID : forall x : real, (real_add x (real_of_num (0))) = x.
Axiom thm_REAL_NEG_0 : (real_neg (real_of_num (0))) = (real_of_num (0)).
Axiom thm_REAL_LE_LNEG : forall x : real, forall y : real, (real_le (real_neg x) y) = (real_le (real_of_num (0)) (real_add x y)).
Axiom thm_REAL_LE_NEG2 : forall x : real, forall y : real, (real_le (real_neg x) (real_neg y)) = (real_le y x).
Axiom thm_REAL_LE_RNEG : forall x : real, forall y : real, (real_le x (real_neg y)) = (real_le (real_add x y) (real_of_num (0))).
...
Axiom thm_REAL_LE_ADD : forall x : real, forall y : real, ((real_le (real_of_num (0)) x) /\ (real_le (real_of_num (0)) y)) -> real_le (real_of_num (0)) (real_add x y).
Axiom thm_REAL_LTE_ANTISYM : forall x : real, forall y : real, ~ ((real_lt x y) /\ (real_le y x)).
Axiom thm_REAL_SUB_LE : forall x : real, forall y : real, (real_le (real_of_num (0)) (real_sub x y)) = (real_le y x).
...
Axiom thm_REAL_SUB_LT : forall x : real, forall y : real, (real_lt (real_of_num (0)) (real_sub x y)) = (real_lt y x).
Axiom thm_REAL_NOT_LT : forall x : real, forall y : real, (~ (real_lt x y)) = (real_le y x).
Axiom thm_REAL_SUB_0 : forall x : real, forall y : real, ((real_sub x y) = (real_of_num (0))) = (x = y).
...
Axiom thm_REAL_LTE_ADD : forall x : real, forall y : real, ((real_lt (real_of_num (0)) x) /\ (real_le (real_of_num (0)) y)) -> real_lt (real_of_num (0)) (real_add x y).
Axiom thm_REAL_LET_ADD : forall x : real, forall y : real, ((real_le (real_of_num (0)) x) /\ (real_lt (real_of_num (0)) y)) -> real_lt (real_of_num (0)) (real_add x y).
Axiom thm_REAL_LT_ADD : forall x : real, forall y : real, ((real_lt (real_of_num (0)) x) /\ (real_lt (real_of_num (0)) y)) -> real_lt (real_of_num (0)) (real_add x y).
Axiom thm_REAL_ENTIRE : forall x : real, forall y : real, ((real_mul x y) = (real_of_num (0))) = ((x = (real_of_num (0))) \/ (y = (real_of_num (0)))).
Axiom thm_REAL_LE_NEGTOTAL : forall x : real, (real_le (real_of_num (0)) x) \/ (real_le (real_of_num (0)) (real_neg x)).
Axiom thm_REAL_LE_SQUARE : forall x : real, real_le (real_of_num (0)) (real_mul x x).
Axiom thm_REAL_MUL_RID : forall x : real, (real_mul x (real_of_num ((BIT1 0)))) = x.
Axiom thm_REAL_POW_2 : forall x : real, (real_pow x ((BIT0 (BIT1 0)))) = (real_mul x x).
Axiom thm_REAL_POLY_CLAUSES : (forall x : real, forall y : real, forall z : real, (real_add x (real_add y z)) = (real_add (real_add x y) z)) /\ ((forall x : real, forall y : real, (real_add x y) = (real_add y x)) /\ ((forall x : real, (real_add (real_of_num (0)) x) = x) /\ ((forall x : real, forall y : real, forall z : real, (real_mul x (real_mul y z)) = (real_mul (real_mul x y) z)) /\ ((forall x : real, forall y : real, (real_mul x y) = (real_mul y x)) /\ ((forall x : real, (real_mul (real_of_num ((BIT1 0))) x) = x) /\ ((forall x : real, (real_mul (real_of_num (0)) x) = (real_of_num (0))) /\ ((forall x : real, forall y : real, forall z : real, (real_mul x (real_add y z)) = (real_add (real_mul x y) (real_mul x z))) /\ ((forall x : real, (real_pow x (0)) = (real_of_num ((BIT1 0)))) /\ (forall x : real, forall n : nat, (real_pow x (S n)) = (real_mul x (real_pow x n))))))))))).
Axiom thm_REAL_POLY_NEG_CLAUSES : (forall x : real, (real_neg x) = (real_mul (real_neg (real_of_num ((BIT1 0)))) x)) /\ (forall x : real, forall y : real, (real_sub x y) = (real_add x (real_mul (real_neg (real_of_num ((BIT1 0)))) y))).
Axiom thm_REAL_POS : forall n : nat, real_le (real_of_num (0)) (real_of_num n).
Axiom thm_REAL_LT_NZ : forall n : nat, (~ ((real_of_num n) = (real_of_num (0)))) = (real_lt (real_of_num (0)) (real_of_num n)).
Axiom thm_REAL_POS_LT : forall n : nat, real_lt (real_of_num (0)) (real_of_num (S n)).
...
Axiom thm_REAL_OF_NUM_SUC : forall n : nat, (real_add (real_of_num n) (real_of_num ((BIT1 0)))) = (real_of_num (S n)).
...
Axiom thm_REAL_LT_MUL : forall x : real, forall y : real, ((real_lt (real_of_num (0)) x) /\ (real_lt (real_of_num (0)) y)) -> real_lt (real_of_num (0)) (real_mul x y).
Axiom thm_REAL_EQ_ADD_LCANCEL_0 : forall x : real, forall y : real, ((real_add x y) = x) = (y = (real_of_num (0))).
Axiom thm_REAL_EQ_ADD_RCANCEL_0 : forall x : real, forall y : real, ((real_add x y) = y) = (x = (real_of_num (0))).
Axiom thm_REAL_LNEG_UNIQ : forall x : real, forall y : real, ((real_add x y) = (real_of_num (0))) = (x = (real_neg y)).
Axiom thm_REAL_RNEG_UNIQ : forall x : real, forall y : real, ((real_add x y) = (real_of_num (0))) = (y = (real_neg x)).
...
Axiom thm_REAL_NEG_LT0 : forall x : real, (real_lt (real_neg x) (real_of_num (0))) = (real_lt (real_of_num (0)) x).
Axiom thm_REAL_NEG_GT0 : forall x : real, (real_lt (real_of_num (0)) (real_neg x)) = (real_lt x (real_of_num (0))).
Axiom thm_REAL_NEG_LE0 : forall x : real, (real_le (real_neg x) (real_of_num (0))) = (real_le (real_of_num (0)) x).
Axiom thm_REAL_NEG_GE0 : forall x : real, (real_le (real_of_num (0)) (real_neg x)) = (real_le x (real_of_num (0))).
Axiom thm_REAL_LT_TOTAL : forall x : real, forall y : real, (x = y) \/ ((real_lt x y) \/ (real_lt y x)).
Axiom thm_REAL_LT_NEGTOTAL : forall x : real, (x = (real_of_num (0))) \/ ((real_lt (real_of_num (0)) x) \/ (real_lt (real_of_num (0)) (real_neg x))).
Axiom thm_REAL_LE_01 : real_le (real_of_num (0)) (real_of_num ((BIT1 0))).
Axiom thm_REAL_LT_01 : real_lt (real_of_num (0)) (real_of_num ((BIT1 0))).
...
Axiom thm_REAL_LT_LNEG : forall x : real, forall y : real, (real_lt (real_neg x) y) = (real_lt (real_of_num (0)) (real_add x y)).
Axiom thm_REAL_LT_RNEG : forall x : real, forall y : real, (real_lt x (real_neg y)) = (real_lt (real_add x y) (real_of_num (0))).
...
Axiom thm_REAL_LT_ADD1 : forall x : real, forall y : real, (real_le x y) -> real_lt x (real_add y (real_of_num ((BIT1 0)))).
...
Axiom thm_REAL_SUB_REFL : forall x : real, (real_sub x x) = (real_of_num (0)).
Axiom thm_REAL_LE_DOUBLE : forall x : real, (real_le (real_of_num (0)) (real_add x x)) = (real_le (real_of_num (0)) x).
Axiom thm_REAL_LE_NEGL : forall x : real, (real_le (real_neg x) x) = (real_le (real_of_num (0)) x).
Axiom thm_REAL_LE_NEGR : forall x : real, (real_le x (real_neg x)) = (real_le x (real_of_num (0))).
Axiom thm_REAL_NEG_EQ_0 : forall x : real, ((real_neg x) = (real_of_num (0))) = (x = (real_of_num (0))).
...
Axiom thm_REAL_NEG_MINUS1 : forall x : real, (real_neg x) = (real_mul (real_neg (real_of_num ((BIT1 0)))) x).
Axiom thm_REAL_LT_IMP_NE : forall x : real, forall y : real, (real_lt x y) -> ~ (x = y).
Axiom thm_REAL_LE_ADDR : forall x : real, forall y : real, (real_le x (real_add x y)) = (real_le (real_of_num (0)) y).
Axiom thm_REAL_LE_ADDL : forall x : real, forall y : real, (real_le y (real_add x y)) = (real_le (real_of_num (0)) x).
Axiom thm_REAL_LT_ADDR : forall x : real, forall y : real, (real_lt x (real_add x y)) = (real_lt (real_of_num (0)) y).
Axiom thm_REAL_LT_ADDL : forall x : real, forall y : real, (real_lt y (real_add x y)) = (real_lt (real_of_num (0)) x).
...
Axiom thm_REAL_SUB_LZERO : forall x : real, (real_sub (real_of_num (0)) x) = (real_neg x).
Axiom thm_REAL_SUB_RZERO : forall x : real, (real_sub x (real_of_num (0))) = x.
...
Axiom thm_REAL_LT_IMP_NZ : forall x : real, (real_lt (real_of_num (0)) x) -> ~ (x = (real_of_num (0))).
...
Axiom thm_REAL_ABS_ZERO : forall x : real, ((real_abs x) = (real_of_num (0))) = (x = (real_of_num (0))).
Axiom thm_REAL_ABS_0 : (real_abs (real_of_num (0))) = (real_of_num (0)).
Axiom thm_REAL_ABS_1 : (real_abs (real_of_num ((BIT1 0)))) = (real_of_num ((BIT1 0))).
...
Axiom thm_REAL_ABS_POS : forall x : real, real_le (real_of_num (0)) (real_abs x).
Axiom thm_REAL_ABS_SUB : forall x : real, forall y : real, (real_abs (real_sub x y)) = (real_abs (real_sub y x)).
Axiom thm_REAL_ABS_NZ : forall x : real, (~ (x = (real_of_num (0)))) = (real_lt (real_of_num (0)) (real_abs x)).
...
Axiom thm_REAL_ABS_REFL : forall x : real, ((real_abs x) = x) = (real_le (real_of_num (0)) x).
Axiom thm_REAL_ABS_BETWEEN : forall x : real, forall y : real, forall d : real, ((real_lt (real_of_num (0)) d) /\ ((real_lt (real_sub x d) y) /\ (real_lt y (real_add x d)))) = (real_lt (real_abs (real_sub y x)) d).
...
Axiom thm_REAL_ABS_STILLNZ : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) (real_abs y)) -> ~ (x = (real_of_num (0))).
Axiom thm_REAL_ABS_CASES : forall x : real, (x = (real_of_num (0))) \/ (real_lt (real_of_num (0)) (real_abs x)).
...
Axiom thm_REAL_ABS_SIGN : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) y) -> real_lt (real_of_num (0)) x.
Axiom thm_REAL_ABS_SIGN2 : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) (real_neg y)) -> real_lt x (real_of_num (0)).
...
Axiom thm_REAL_ABS_BETWEEN2 : forall x0 : real, forall x : real, forall y0 : real, forall y : real, ((real_lt x0 y0) /\ ((real_lt (real_mul (real_of_num ((BIT0 (BIT1 0)))) (real_abs (real_sub x x0))) (real_sub y0 x0)) /\ (real_lt (real_mul (real_of_num ((BIT0 (BIT1 0)))) (real_abs (real_sub y y0))) (real_sub y0 x0)))) -> real_lt x y.
...
Axiom thm_REAL_POW_LE : forall x : real, forall n : nat, (real_le (real_of_num (0)) x) -> real_le (real_of_num (0)) (real_pow x n).
Axiom thm_REAL_POW_LT : forall x : real, forall n : nat, (real_lt (real_of_num (0)) x) -> real_lt (real_of_num (0)) (real_pow x n).
Axiom thm_REAL_ABS_POW : forall x : real, forall n : nat, (real_abs (real_pow x n)) = (real_pow (real_abs x) n).
Axiom thm_REAL_LE_LMUL : forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (0)) x) /\ (real_le y z)) -> real_le (real_mul x y) (real_mul x z).
Axiom thm_REAL_LE_RMUL : forall x : real, forall y : real, forall z : real, ((real_le x y) /\ (real_le (real_of_num (0)) z)) -> real_le (real_mul x z) (real_mul y z).
Axiom thm_REAL_LT_LMUL : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (0)) x) /\ (real_lt y z)) -> real_lt (real_mul x y) (real_mul x z).
Axiom thm_REAL_LT_RMUL : forall x : real, forall y : real, forall z : real, ((real_lt x y) /\ (real_lt (real_of_num (0)) z)) -> real_lt (real_mul x z) (real_mul y z).
Axiom thm_REAL_EQ_MUL_LCANCEL : forall x : real, forall y : real, forall z : real, ((real_mul x y) = (real_mul x z)) = ((x = (real_of_num (0))) \/ (y = z)).
Axiom thm_REAL_EQ_MUL_RCANCEL : forall x : real, forall y : real, forall z : real, ((real_mul x z) = (real_mul y z)) = ((x = y) \/ (z = (real_of_num (0)))).
Axiom thm_REAL_MUL_LINV_UNIQ : forall x : real, forall y : real, ((real_mul x y) = (real_of_num ((BIT1 0)))) -> (real_inv y) = x.
Axiom thm_REAL_MUL_RINV_UNIQ : forall x : real, forall y : real, ((real_mul x y) = (real_of_num ((BIT1 0)))) -> (real_inv x) = y.
...
Axiom thm_REAL_INV_EQ_0 : forall x : real, ((real_inv x) = (real_of_num (0))) = (x = (real_of_num (0))).
Axiom thm_REAL_LT_INV : forall x : real, (real_lt (real_of_num (0)) x) -> real_lt (real_of_num (0)) (real_inv x).
Axiom thm_REAL_LT_INV_EQ : forall x : real, (real_lt (real_of_num (0)) (real_inv x)) = (real_lt (real_of_num (0)) x).
Axiom thm_REAL_INV_NEG : forall x : real, (real_inv (real_neg x)) = (real_neg (real_inv x)).
Axiom thm_REAL_LE_INV_EQ : forall x : real, (real_le (real_of_num (0)) (real_inv x)) = (real_le (real_of_num (0)) x).
Axiom thm_REAL_LE_INV : forall x : real, (real_le (real_of_num (0)) x) -> real_le (real_of_num (0)) (real_inv x).
Axiom thm_REAL_MUL_RINV : forall x : real, (~ (x = (real_of_num (0)))) -> (real_mul x (real_inv x)) = (real_of_num ((BIT1 0))).
Axiom thm_REAL_INV_1 : (real_inv (real_of_num ((BIT1 0)))) = (real_of_num ((BIT1 0))).
Axiom thm_REAL_INV_EQ_1 : forall x : real, ((real_inv x) = (real_of_num ((BIT1 0)))) = (x = (real_of_num ((BIT1 0)))).
Axiom thm_REAL_DIV_1 : forall x : real, (real_div x (real_of_num ((BIT1 0)))) = x.
Axiom thm_REAL_DIV_REFL : forall x : real, (~ (x = (real_of_num (0)))) -> (real_div x x) = (real_of_num ((BIT1 0))).
Axiom thm_REAL_DIV_RMUL : forall x : real, forall y : real, (~ (y = (real_of_num (0)))) -> (real_mul (real_div x y) y) = x.
Axiom thm_REAL_DIV_LMUL : forall x : real, forall y : real, (~ (y = (real_of_num (0)))) -> (real_mul y (real_div x y)) = x.
Axiom thm_REAL_DIV_EQ_1 : forall x : real, forall y : real, ((real_div x y) = (real_of_num ((BIT1 0)))) = ((x = y) /\ ((~ (x = (real_of_num (0)))) /\ (~ (y = (real_of_num (0)))))).
...
Axiom thm_REAL_DIV_EQ_0 : forall x : real, forall y : real, ((real_div x y) = (real_of_num (0))) = ((x = (real_of_num (0))) \/ (y = (real_of_num (0)))).
Axiom thm_REAL_POW_ADD : forall x : real, forall m : nat, forall n : nat, (real_pow x (Nat.add m n)) = (real_mul (real_pow x m) (real_pow x n)).
Axiom thm_REAL_POW_NZ : forall x : real, forall n : nat, (~ (x = (real_of_num (0)))) -> ~ ((real_pow x n) = (real_of_num (0))).
Axiom thm_REAL_POW_SUB : forall x : real, forall m : nat, forall n : nat, ((~ (x = (real_of_num (0)))) /\ (Peano.le m n)) -> (real_pow x (Nat.sub n m)) = (real_div (real_pow x n) (real_pow x m)).
Axiom thm_REAL_LT_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (0)) x) /\ (real_lt (real_mul x y) (real_mul x z))) -> real_lt y z.
Axiom thm_REAL_LT_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (0)) z) /\ (real_lt (real_mul x z) (real_mul y z))) -> real_lt x y.
Axiom thm_REAL_LE_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (0)) x) /\ (real_le (real_mul x y) (real_mul x z))) -> real_le y z.
Axiom thm_REAL_LE_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (0)) z) /\ (real_le (real_mul x z) (real_mul y z))) -> real_le x y.
Axiom thm_REAL_LE_RMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_le (real_mul x z) (real_mul y z)) = (real_le x y).
Axiom thm_REAL_LE_LMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_le (real_mul z x) (real_mul z y)) = (real_le x y).
Axiom thm_REAL_LT_RMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_lt (real_mul x z) (real_mul y z)) = (real_lt x y).
Axiom thm_REAL_LT_LMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_lt (real_mul z x) (real_mul z y)) = (real_lt x y).
Axiom thm_REAL_LE_MUL_EQ : (forall x : real, forall y : real, (real_lt (real_of_num (0)) x) -> (real_le (real_of_num (0)) (real_mul x y)) = (real_le (real_of_num (0)) y)) /\ (forall x : real, forall y : real, (real_lt (real_of_num (0)) y) -> (real_le (real_of_num (0)) (real_mul x y)) = (real_le (real_of_num (0)) x)).
Axiom thm_REAL_LT_MUL_EQ : (forall x : real, forall y : real, (real_lt (real_of_num (0)) x) -> (real_lt (real_of_num (0)) (real_mul x y)) = (real_lt (real_of_num (0)) y)) /\ (forall x : real, forall y : real, (real_lt (real_of_num (0)) y) -> (real_lt (real_of_num (0)) (real_mul x y)) = (real_lt (real_of_num (0)) x)).
Axiom thm_REAL_MUL_POS_LT : forall x : real, forall y : real, (real_lt (real_of_num (0)) (real_mul x y)) = (((real_lt (real_of_num (0)) x) /\ (real_lt (real_of_num (0)) y)) \/ ((real_lt x (real_of_num (0))) /\ (real_lt y (real_of_num (0))))).
Axiom thm_REAL_MUL_POS_LE : forall x : real, forall y : real, (real_le (real_of_num (0)) (real_mul x y)) = ((x = (real_of_num (0))) \/ ((y = (real_of_num (0))) \/ (((real_lt (real_of_num (0)) x) /\ (real_lt (real_of_num (0)) y)) \/ ((real_lt x (real_of_num (0))) /\ (real_lt y (real_of_num (0))))))).
Axiom thm_REAL_LE_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_le x (real_div y z)) = (real_le (real_mul x z) y).
Axiom thm_REAL_LE_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_le (real_div x z) y) = (real_le x (real_mul y z)).
Axiom thm_REAL_LT_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_lt x (real_div y z)) = (real_lt (real_mul x z) y).
Axiom thm_REAL_LT_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_lt (real_div x z) y) = (real_lt x (real_mul y z)).
Axiom thm_REAL_EQ_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (x = (real_div y z)) = ((real_mul x z) = y).
Axiom thm_REAL_EQ_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> ((real_div x z) = y) = (x = (real_mul y z)).
Axiom thm_REAL_LT_DIV2_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_lt (real_div x z) (real_div y z)) = (real_lt x y).
Axiom thm_REAL_LE_DIV2_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (0)) z) -> (real_le (real_div x z) (real_div y z)) = (real_le x y).
Axiom thm_REAL_MUL_2 : forall x : real, (real_mul (real_of_num ((BIT0 (BIT1 0)))) x) = (real_add x x).
Axiom thm_REAL_POW_EQ_0 : forall x : real, forall n : nat, ((real_pow x n) = (real_of_num (0))) = ((x = (real_of_num (0))) /\ (~ (n = (0)))).
Axiom thm_REAL_LE_MUL2 : forall w : real, forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (0)) w) /\ ((real_le w x) /\ ((real_le (real_of_num (0)) y) /\ (real_le y z)))) -> real_le (real_mul w y) (real_mul x z).
Axiom thm_REAL_LT_MUL2 : forall w : real, forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (0)) w) /\ ((real_lt w x) /\ ((real_le (real_of_num (0)) y) /\ (real_lt y z)))) -> real_lt (real_mul w y) (real_mul x z).
Axiom thm_REAL_LT_SQUARE : forall x : real, (real_lt (real_of_num (0)) (real_mul x x)) = (~ (x = (real_of_num (0)))).
Axiom thm_REAL_POW_1 : forall x : real, (real_pow x ((BIT1 0))) = x.
Axiom thm_REAL_POW_ONE : forall n : nat, (real_pow (real_of_num ((BIT1 0))) n) = (real_of_num ((BIT1 0))).
Axiom thm_REAL_LT_INV2 : forall x : real, forall y : real, ((real_lt (real_of_num (0)) x) /\ (real_lt x y)) -> real_lt (real_inv y) (real_inv x).
Axiom thm_REAL_LE_INV2 : forall x : real, forall y : real, ((real_lt (real_of_num (0)) x) /\ (real_le x y)) -> real_le (real_inv y) (real_inv x).
Axiom thm_REAL_LT_LINV : forall x : real, forall y : real, ((real_lt (real_of_num (0)) y) /\ (real_lt (real_inv y) x)) -> real_lt (real_inv x) y.
Axiom thm_REAL_LT_RINV : forall x : real, forall y : real, ((real_lt (real_of_num (0)) x) /\ (real_lt x (real_inv y))) -> real_lt y (real_inv x).
Axiom thm_REAL_LE_LINV : forall x : real, forall y : real, ((real_lt (real_of_num (0)) y) /\ (real_le (real_inv y) x)) -> real_le (real_inv x) y.
Axiom thm_REAL_LE_RINV : forall x : real, forall y : real, ((real_lt (real_of_num (0)) x) /\ (real_le x (real_inv y))) -> real_le y (real_inv x).
Axiom thm_REAL_INV_LE_1 : forall x : real, (real_le (real_of_num ((BIT1 0))) x) -> real_le (real_inv x) (real_of_num ((BIT1 0))).
Axiom thm_REAL_INV_1_LE : forall x : real, ((real_lt (real_of_num (0)) x) /\ (real_le x (real_of_num ((BIT1 0))))) -> real_le (real_of_num ((BIT1 0))) (real_inv x).
Axiom thm_REAL_INV_LT_1 : forall x : real, (real_lt (real_of_num ((BIT1 0))) x) -> real_lt (real_inv x) (real_of_num ((BIT1 0))).
Axiom thm_REAL_INV_1_LT : forall x : real, ((real_lt (real_of_num (0)) x) /\ (real_lt x (real_of_num ((BIT1 0))))) -> real_lt (real_of_num ((BIT1 0))) (real_inv x).
Axiom thm_REAL_SUB_INV : forall x : real, forall y : real, ((~ (x = (real_of_num (0)))) /\ (~ (y = (real_of_num (0))))) -> (real_sub (real_inv x) (real_inv y)) = (real_div (real_sub y x) (real_mul x y)).
Axiom thm_REAL_DOWN : forall d : real, (real_lt (real_of_num (0)) d) -> exists e : real, (real_lt (real_of_num (0)) e) /\ (real_lt e d).
Axiom thm_REAL_DOWN2 : forall d1 : real, forall d2 : real, ((real_lt (real_of_num (0)) d1) /\ (real_lt (real_of_num (0)) d2)) -> exists e : real, (real_lt (real_of_num (0)) e) /\ ((real_lt e d1) /\ (real_lt e d2)).
Axiom thm_REAL_POW_LE2 : forall n : nat, forall x : real, forall y : real, ((real_le (real_of_num (0)) x) /\ (real_le x y)) -> real_le (real_pow x n) (real_pow y n).
Axiom thm_REAL_POW_LE_1 : forall n : nat, forall x : real, (real_le (real_of_num ((BIT1 0))) x) -> real_le (real_of_num ((BIT1 0))) (real_pow x n).
Axiom thm_REAL_POW_1_LE : forall n : nat, forall x : real, ((real_le (real_of_num (0)) x) /\ (real_le x (real_of_num ((BIT1 0))))) -> real_le (real_pow x n) (real_of_num ((BIT1 0))).
Axiom thm_REAL_POW_MONO : forall m : nat, forall n : nat, forall x : real, ((real_le (real_of_num ((BIT1 0))) x) /\ (Peano.le m n)) -> real_le (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_LT2 : forall n : nat, forall x : real, forall y : real, ((~ (n = (0))) /\ ((real_le (real_of_num (0)) x) /\ (real_lt x y))) -> real_lt (real_pow x n) (real_pow y n).
Axiom thm_REAL_POW_LT_1 : forall n : nat, forall x : real, ((~ (n = (0))) /\ (real_lt (real_of_num ((BIT1 0))) x)) -> real_lt (real_of_num ((BIT1 0))) (real_pow x n).
Axiom thm_REAL_POW_1_LT : forall n : nat, forall x : real, ((~ (n = (0))) /\ ((real_le (real_of_num (0)) x) /\ (real_lt x (real_of_num ((BIT1 0)))))) -> real_lt (real_pow x n) (real_of_num ((BIT1 0))).
Axiom thm_REAL_POW_MONO_LT : forall m : nat, forall n : nat, forall x : real, ((real_lt (real_of_num ((BIT1 0))) x) /\ (Peano.lt m n)) -> real_lt (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_POW : forall x : real, forall m : nat, forall n : nat, (real_pow (real_pow x m) n) = (real_pow x (Nat.mul m n)).
Axiom thm_REAL_EQ_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((~ (z = (real_of_num (0)))) /\ ((real_mul x z) = (real_mul y z))) -> x = y.
Axiom thm_REAL_EQ_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((~ (z = (real_of_num (0)))) /\ ((real_mul z x) = (real_mul z y))) -> x = y.
Axiom thm_REAL_LT_DIV : forall x : real, forall y : real, ((real_lt (real_of_num (0)) x) /\ (real_lt (real_of_num (0)) y)) -> real_lt (real_of_num (0)) (real_div x y).
Axiom thm_REAL_LE_DIV : forall x : real, forall y : real, ((real_le (real_of_num (0)) x) /\ (real_le (real_of_num (0)) y)) -> real_le (real_of_num (0)) (real_div x y).
Axiom thm_REAL_DIV_POW2 : forall x : real, forall m : nat, forall n : nat, (~ (x = (real_of_num (0)))) -> (real_div (real_pow x m) (real_pow x n)) = (@COND real (Peano.le n m) (real_pow x (Nat.sub m n)) (real_inv (real_pow x (Nat.sub n m)))).
Axiom thm_REAL_DIV_POW2_ALT : forall x : real, forall m : nat, forall n : nat, (~ (x = (real_of_num (0)))) -> (real_div (real_pow x m) (real_pow x n)) = (@COND real (Peano.lt n m) (real_pow x (Nat.sub m n)) (real_inv (real_pow x (Nat.sub n m)))).
Axiom thm_REAL_LT_POW2 : forall n : nat, real_lt (real_of_num (0)) (real_pow (real_of_num ((BIT0 (BIT1 0)))) n).
Axiom thm_REAL_LE_POW2 : forall n : nat, real_le (real_of_num ((BIT1 0))) (real_pow (real_of_num ((BIT0 (BIT1 0)))) n).
Axiom thm_REAL_POW2_ABS : forall x : real, (real_pow (real_abs x) ((BIT0 (BIT1 0)))) = (real_pow x ((BIT0 (BIT1 0)))).
Axiom thm_REAL_LE_SQUARE_ABS : forall x : real, forall y : real, (real_le (real_abs x) (real_abs y)) = (real_le (real_pow x ((BIT0 (BIT1 0)))) (real_pow y ((BIT0 (BIT1 0))))).
Axiom thm_REAL_LT_SQUARE_ABS : forall x : real, forall y : real, (real_lt (real_abs x) (real_abs y)) = (real_lt (real_pow x ((BIT0 (BIT1 0)))) (real_pow y ((BIT0 (BIT1 0))))).
Axiom thm_REAL_EQ_SQUARE_ABS : forall x : real, forall y : real, ((real_abs x) = (real_abs y)) = ((real_pow x ((BIT0 (BIT1 0)))) = (real_pow y ((BIT0 (BIT1 0))))).
Axiom thm_REAL_LE_POW_2 : forall x : real, real_le (real_of_num (0)) (real_pow x ((BIT0 (BIT1 0)))).
Axiom thm_REAL_LT_POW_2 : forall x : real, (real_lt (real_of_num (0)) (real_pow x ((BIT0 (BIT1 0))))) = (~ (x = (real_of_num (0)))).
Axiom thm_REAL_SOS_EQ_0 : forall x : real, forall y : real, ((real_add (real_pow x ((BIT0 (BIT1 0)))) (real_pow y ((BIT0 (BIT1 0))))) = (real_of_num (0))) = ((x = (real_of_num (0))) /\ (y = (real_of_num (0)))).
Axiom thm_REAL_POW_ZERO : forall n : nat, (real_pow (real_of_num (0)) n) = (@COND real (n = (0)) (real_of_num ((BIT1 0))) (real_of_num (0))).
Axiom thm_REAL_POW_MONO_INV : forall m : nat, forall n : nat, forall x : real, ((real_le (real_of_num (0)) x) /\ ((real_le x (real_of_num ((BIT1 0)))) /\ (Peano.le n m))) -> real_le (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_LE2_REV : forall n : nat, forall x : real, forall y : real, ((~ (n = (0))) /\ ((real_le (real_of_num (0)) y) /\ (real_le (real_pow x n) (real_pow y n)))) -> real_le x y.
Axiom thm_REAL_POW_LT2_REV : forall n : nat, forall x : real, forall y : real, ((real_le (real_of_num (0)) y) /\ (real_lt (real_pow x n) (real_pow y n))) -> real_lt x y.
Axiom thm_REAL_POW_EQ : forall n : nat, forall x : real, forall y : real, ((~ (n = (0))) /\ ((real_le (real_of_num (0)) x) /\ ((real_le (real_of_num (0)) y) /\ ((real_pow x n) = (real_pow y n))))) -> x = y.
Axiom thm_REAL_POW_EQ_ABS : forall n : nat, forall x : real, forall y : real, ((~ (n = (0))) /\ ((real_pow x n) = (real_pow y n))) -> (real_abs x) = (real_abs y).
Axiom thm_REAL_POW_EQ_1_IMP : forall x : real, forall n : nat, ((~ (n = (0))) /\ ((real_pow x n) = (real_of_num ((BIT1 0))))) -> (real_abs x) = (real_of_num ((BIT1 0))).
Axiom thm_REAL_POW_EQ_1 : forall x : real, forall n : nat, ((real_pow x n) = (real_of_num ((BIT1 0)))) = ((((real_abs x) = (real_of_num ((BIT1 0)))) /\ ((real_lt x (real_of_num (0))) -> Stdlib.Arith.PeanoNat.Nat.Even n)) \/ (n = (0))).
...
Axiom thm_REAL_POW_EQ_EQ : forall n : nat, forall x : real, forall y : real, ((real_pow x n) = (real_pow y n)) = (@COND Prop (Stdlib.Arith.PeanoNat.Nat.Even n) ((n = (0)) \/ ((real_abs x) = (real_abs y))) (x = y)).
...
Axiom thm_REAL_CONVEX_BOUND2_LT : forall (b : real), forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_lt x a) /\ ((real_lt y b) /\ ((real_le (real_of_num (0)) u) /\ ((real_le (real_of_num (0)) v) /\ ((real_add u v) = (real_of_num ((BIT1 0)))))))) -> real_lt (real_add (real_mul u x) (real_mul v y)) (real_add (real_mul u a) (real_mul v b)).
Axiom thm_REAL_CONVEX_BOUND2_LE : forall (b : real), forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le x a) /\ ((real_le y b) /\ ((real_le (real_of_num (0)) u) /\ ((real_le (real_of_num (0)) v) /\ ((real_add u v) = (real_of_num ((BIT1 0)))))))) -> real_le (real_add (real_mul u x) (real_mul v y)) (real_add (real_mul u a) (real_mul v b)).
Axiom thm_REAL_CONVEX_BOUND_LT : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_lt x a) /\ ((real_lt y a) /\ ((real_le (real_of_num (0)) u) /\ ((real_le (real_of_num (0)) v) /\ ((real_add u v) = (real_of_num ((BIT1 0)))))))) -> real_lt (real_add (real_mul u x) (real_mul v y)) a.
Axiom thm_REAL_CONVEX_BOUND_LE : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le x a) /\ ((real_le y a) /\ ((real_le (real_of_num (0)) u) /\ ((real_le (real_of_num (0)) v) /\ ((real_add u v) = (real_of_num ((BIT1 0)))))))) -> real_le (real_add (real_mul u x) (real_mul v y)) a.
Axiom thm_REAL_CONVEX_BOUND_GT : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_lt a x) /\ ((real_lt a y) /\ ((real_le (real_of_num (0)) u) /\ ((real_le (real_of_num (0)) v) /\ ((real_add u v) = (real_of_num ((BIT1 0)))))))) -> real_lt a (real_add (real_mul u x) (real_mul v y)).
Axiom thm_REAL_CONVEX_BOUND_GE : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le a x) /\ ((real_le a y) /\ ((real_le (real_of_num (0)) u) /\ ((real_le (real_of_num (0)) v) /\ ((real_add u v) = (real_of_num ((BIT1 0)))))))) -> real_le a (real_add (real_mul u x) (real_mul v y)).
Axiom thm_REAL_CONVEX_BOUNDS_LE : forall x : real, forall y : real, forall a : real, forall b : real, forall u : real, forall v : real, ((real_le a x) /\ ((real_le x b) /\ ((real_le a y) /\ ((real_le y b) /\ ((real_le (real_of_num (0)) u) /\ ((real_le (real_of_num (0)) v) /\ ((real_add u v) = (real_of_num ((BIT1 0)))))))))) -> (real_le a (real_add (real_mul u x) (real_mul v y))) /\ (real_le (real_add (real_mul u x) (real_mul v y)) b).
Axiom thm_REAL_CONVEX_BOUNDS_LT : forall x : real, forall y : real, forall a : real, forall b : real, forall u : real, forall v : real, ((real_lt a x) /\ ((real_lt x b) /\ ((real_lt a y) /\ ((real_lt y b) /\ ((real_le (real_of_num (0)) u) /\ ((real_le (real_of_num (0)) v) /\ ((real_add u v) = (real_of_num ((BIT1 0)))))))))) -> (real_lt a (real_add (real_mul u x) (real_mul v y))) /\ (real_lt (real_add (real_mul u x) (real_mul v y)) b).
...
Axiom thm_REAL_ARCH : forall x : real, (real_lt (real_of_num (0)) x) -> forall y : real, exists n : nat, real_lt y (real_mul (real_of_num n) x).
Axiom thm_REAL_ARCH_INV : forall e : real, (real_lt (real_of_num (0)) e) = (exists n : nat, (~ (n = (0))) /\ ((real_lt (real_of_num (0)) (real_inv (real_of_num n))) /\ (real_lt (real_inv (real_of_num n)) e))).
Axiom thm_REAL_POW_LBOUND : forall x : real, forall n : nat, (real_le (real_of_num (0)) x) -> real_le (real_add (real_of_num ((BIT1 0))) (real_mul (real_of_num n) x)) (real_pow (real_add (real_of_num ((BIT1 0))) x) n).
Axiom thm_REAL_ARCH_POW : forall x : real, forall y : real, (real_lt (real_of_num ((BIT1 0))) x) -> exists n : nat, real_lt y (real_pow x n).
Axiom thm_REAL_ARCH_POW2 : forall x : real, exists n : nat, real_lt x (real_pow (real_of_num ((BIT0 (BIT1 0)))) n).
Axiom thm_REAL_ARCH_POW_INV : forall x : real, forall y : real, ((real_lt (real_of_num (0)) y) /\ (real_lt x (real_of_num ((BIT1 0))))) -> exists n : nat, real_lt (real_pow x n) y.
Axiom thm_real_sgn : forall x : real, (real_sgn x) = (@COND real (real_lt (real_of_num (0)) x) (real_of_num ((BIT1 0))) (@COND real (real_lt x (real_of_num (0))) (real_neg (real_of_num ((BIT1 0)))) (real_of_num (0)))).
Axiom thm_REAL_SGN_0 : (real_sgn (real_of_num (0))) = (real_of_num (0)).
...
Axiom thm_REAL_SGN_EQ : (forall x : real, ((real_sgn x) = (real_of_num (0))) = (x = (real_of_num (0)))) /\ ((forall x : real, ((real_sgn x) = (real_of_num ((BIT1 0)))) = (real_gt x (real_of_num (0)))) /\ (forall x : real, ((real_sgn x) = (real_neg (real_of_num ((BIT1 0))))) = (real_lt x (real_of_num (0))))).
Axiom thm_REAL_SGN_CASES : forall x : real, ((real_sgn x) = (real_of_num (0))) \/ (((real_sgn x) = (real_of_num ((BIT1 0)))) \/ ((real_sgn x) = (real_neg (real_of_num ((BIT1 0)))))).
Axiom thm_REAL_SGN_INEQS : (forall x : real, (real_le (real_of_num (0)) (real_sgn x)) = (real_le (real_of_num (0)) x)) /\ ((forall x : real, (real_lt (real_of_num (0)) (real_sgn x)) = (real_lt (real_of_num (0)) x)) /\ ((forall x : real, (real_ge (real_of_num (0)) (real_sgn x)) = (real_ge (real_of_num (0)) x)) /\ ((forall x : real, (real_gt (real_of_num (0)) (real_sgn x)) = (real_gt (real_of_num (0)) x)) /\ ((forall x : real, ((real_of_num (0)) = (real_sgn x)) = ((real_of_num (0)) = x)) /\ ((forall x : real, (real_le (real_sgn x) (real_of_num (0))) = (real_le x (real_of_num (0)))) /\ ((forall x : real, (real_lt (real_sgn x) (real_of_num (0))) = (real_lt x (real_of_num (0)))) /\ ((forall x : real, (real_ge (real_sgn x) (real_of_num (0))) = (real_ge x (real_of_num (0)))) /\ ((forall x : real, (real_gt (real_sgn x) (real_of_num (0))) = (real_gt x (real_of_num (0)))) /\ (forall x : real, ((real_sgn x) = (real_of_num (0))) = (x = (real_of_num (0)))))))))))).
Axiom thm_REAL_SGN_POW : forall x : real, forall n : nat, (real_sgn (real_pow x n)) = (real_pow (real_sgn x) n).
Axiom thm_REAL_SGN_POW_2 : forall x : real, (real_sgn (real_pow x ((BIT0 (BIT1 0))))) = (real_sgn (real_abs x)).
...
Axiom thm_REAL_SGNS_EQ : forall x : real, forall y : real, ((real_sgn x) = (real_sgn y)) = (((x = (real_of_num (0))) = (y = (real_of_num (0)))) /\ (((real_gt x (real_of_num (0))) = (real_gt y (real_of_num (0)))) /\ ((real_lt x (real_of_num (0))) = (real_lt y (real_of_num (0)))))).
Axiom thm_REAL_SGNS_EQ_ALT : forall x : real, forall y : real, ((real_sgn x) = (real_sgn y)) = (((x = (real_of_num (0))) -> y = (real_of_num (0))) /\ (((real_gt x (real_of_num (0))) -> real_gt y (real_of_num (0))) /\ ((real_lt x (real_of_num (0))) -> real_lt y (real_of_num (0))))).
...
Axiom thm_sqrt : forall x : real, (sqrt x) = (@ε real (fun y : real => ((real_sgn y) = (real_sgn x)) /\ ((real_pow y ((BIT0 (BIT1 0)))) = (real_abs x)))).
Axiom thm_SQRT_UNIQUE : forall x : real, forall y : real, ((real_le (real_of_num (0)) y) /\ ((real_pow y ((BIT0 (BIT1 0)))) = x)) -> (sqrt x) = y.
Axiom thm_POW_2_SQRT : forall x : real, (real_le (real_of_num (0)) x) -> (sqrt (real_pow x ((BIT0 (BIT1 0))))) = x.
Axiom thm_SQRT_0 : (sqrt (real_of_num (0))) = (real_of_num (0)).
Axiom thm_SQRT_1 : (sqrt (real_of_num ((BIT1 0)))) = (real_of_num ((BIT1 0))).
Axiom thm_POW_2_SQRT_ABS : forall x : real, (sqrt (real_pow x ((BIT0 (BIT1 0))))) = (real_abs x).
Axiom thm_SQRT_WORKS_GEN : forall x : real, ((real_sgn (sqrt x)) = (real_sgn x)) /\ ((real_pow (sqrt x) ((BIT0 (BIT1 0)))) = (real_abs x)).
Axiom thm_SQRT_UNIQUE_GEN : forall x : real, forall y : real, (((real_sgn y) = (real_sgn x)) /\ ((real_pow y ((BIT0 (BIT1 0)))) = (real_abs x))) -> (sqrt x) = y.
...
Axiom thm_SQRT_WORKS : forall x : real, (real_le (real_of_num (0)) x) -> (real_le (real_of_num (0)) (sqrt x)) /\ ((real_pow (sqrt x) ((BIT0 (BIT1 0)))) = x).
Axiom thm_REAL_POS_EQ_SQUARE : forall x : real, (real_le (real_of_num (0)) x) = (exists y : real, (real_pow y ((BIT0 (BIT1 0)))) = x).
Axiom thm_SQRT_POS_LE : forall x : real, (real_le (real_of_num (0)) x) -> real_le (real_of_num (0)) (sqrt x).
Axiom thm_SQRT_POW_2 : forall x : real, (real_le (real_of_num (0)) x) -> (real_pow (sqrt x) ((BIT0 (BIT1 0)))) = x.
Axiom thm_SQRT_POW2 : forall x : real, ((real_pow (sqrt x) ((BIT0 (BIT1 0)))) = x) = (real_le (real_of_num (0)) x).
...
Axiom thm_SQRT_LT_0 : forall x : real, (real_lt (real_of_num (0)) (sqrt x)) = (real_lt (real_of_num (0)) x).
Axiom thm_SQRT_EQ_0 : forall x : real, ((sqrt x) = (real_of_num (0))) = (x = (real_of_num (0))).
Axiom thm_SQRT_LE_0 : forall x : real, (real_le (real_of_num (0)) (sqrt x)) = (real_le (real_of_num (0)) x).
...
Axiom thm_SQRT_EQ_1 : forall x : real, ((sqrt x) = (real_of_num ((BIT1 0)))) = (x = (real_of_num ((BIT1 0)))).
Axiom thm_SQRT_POS_LT : forall x : real, (real_lt (real_of_num (0)) x) -> real_lt (real_of_num (0)) (sqrt x).
Axiom thm_REAL_LE_LSQRT : forall x : real, forall y : real, ((real_le (real_of_num (0)) y) /\ (real_le x (real_pow y ((BIT0 (BIT1 0)))))) -> real_le (sqrt x) y.
Axiom thm_REAL_LE_RSQRT : forall x : real, forall y : real, (real_le (real_pow x ((BIT0 (BIT1 0)))) y) -> real_le x (sqrt y).
Axiom thm_REAL_LT_LSQRT : forall x : real, forall y : real, ((real_le (real_of_num (0)) y) /\ (real_lt x (real_pow y ((BIT0 (BIT1 0)))))) -> real_lt (sqrt x) y.
Axiom thm_REAL_LT_RSQRT : forall x : real, forall y : real, (real_lt (real_pow x ((BIT0 (BIT1 0)))) y) -> real_lt x (sqrt y).
Axiom thm_SQRT_EVEN_POW2 : forall n : nat, (Stdlib.Arith.PeanoNat.Nat.Even n) -> (sqrt (real_pow (real_of_num ((BIT0 (BIT1 0)))) n)) = (real_pow (real_of_num ((BIT0 (BIT1 0)))) (Nat.div n ((BIT0 (BIT1 0))))).
Axiom thm_REAL_DIV_SQRT : forall x : real, (real_le (real_of_num (0)) x) -> (real_div x (sqrt x)) = (sqrt x).
Axiom thm_REAL_RSQRT_LE : forall x : real, forall y : real, ((real_le (real_of_num (0)) x) /\ ((real_le (real_of_num (0)) y) /\ (real_le x (sqrt y)))) -> real_le (real_pow x ((BIT0 (BIT1 0)))) y.
Axiom thm_REAL_LSQRT_LE : forall x : real, forall y : real, ((real_le (real_of_num (0)) x) /\ (real_le (sqrt x) y)) -> real_le x (real_pow y ((BIT0 (BIT1 0)))).
Axiom thm_REAL_SQRT_POW_2 : forall x : real, (real_pow (sqrt x) ((BIT0 (BIT1 0)))) = (real_abs x).
Axiom thm_REAL_ABS_LE_SQRT_POS : forall x : real, forall y : real, ((real_le (real_of_num (0)) x) /\ (real_le (real_of_num (0)) y)) -> real_le (real_abs (real_sub (sqrt x) (sqrt y))) (sqrt (real_abs (real_sub x y))).
Axiom thm_REAL_ABS_LE_SQRT : forall x : real, forall y : real, real_le (real_abs (real_sub (sqrt x) (sqrt y))) (sqrt (real_mul (real_of_num ((BIT0 (BIT1 0)))) (real_abs (real_sub x y)))).
